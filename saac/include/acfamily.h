...
#define MIN_MEMBERNUM 1 // 10

#ifdef _FIX_10_FMPOINT // WON ADD �Ŵ�ׯ԰
#define MAX_FMPOINT 10
#else
#define MAX_FMPOINT 4 // 4
#endif

#define PREDEL_TIME 60 * 60 * 24 * 7		// ���� 60*60*24*3
#define PREDELMEMBER_TIME 60 * 60 * 24 * 60 // 30�� 60*60*24*30
#define FAMILY_MEMONUM 35					// �������԰������������
#define FAMILY_MEMOLEN 256
#define FMSMEMOINDEX 10000 // ����֮�����԰� index
#define FMSMEMONUM 140
#define TOPFMLISTNUM 10 // �������а�����
...
#define MINAPPLYPNUM 10 // ��������������
#define FMMEMBERINDEX "fmmember"
#define FMMEMOLIST "memo"
#define FMELDERNUM 5		 // ��������
#define FMMAXGOLD 1000000000 // �����������

// shan 20011207
#define MAXRECVPOP 5000000 // ��������ת������
// CoolFish: 2001/11/26
//#define MAXRECVPOP			2500000		// ��������ת������

...
#ifdef _ALCHEMIST
#define LSSPROTO_ALCHEPLUS_RECV 135
#define LSSPROTO_ALCHEPLUS_SEND 136
...
#define LSSPROTO_BATTLEBUTTON_SEND 150
#endif
...
#define LSSPROTO_GETINFO_SEND 209
#define LSSPROTO_GETINFO_RECV 210
void lssproto_GetInfo_send(int fd);
#endif

#define LSSPROTO_BATTLETIME_SEND 211

#define LSSPROTO_EFFECT_SEND 212
#define LSSPROTO_EFFECT_RECV 213

#define LSSPROTO_CHAREFFECT_SEND 214
void lssproto_CHAREFFECT_send(int fd, char *message);

#define LSSPROTO_GMSET_RECV 301

#define LSSPROTO_EXPUP_RECV 400
void lssproto_expup_recv(int fd);

#define LSSPROTO_NOENEMY_RECV 401
void lssproto_noenemy_recv(int fd);

#define LSSPROTO_PARTYAUTO_RECV 402
void lssproto_partyauto_recv(int fd);

#define LSSPROTO_PETSHOPCALL_RECV 450
#define LSSPROTO_POOLITEMCALL_RECV 451

#define LSSPROTO_MAMMOTH_RECV 500
#define LSSPROTO_MAMMOTH_SEND 501
#define LSSPROTO_MAMMOTH_OPEN_SEND 502

#define LSSPROTO_PETRANK_RECV 503
#define LSSPROTO_PETRANK_SEND 504

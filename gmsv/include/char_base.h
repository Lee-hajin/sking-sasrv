...
#define MAX_PERSONAL_MOMENTUM 2140000000
#endif
#ifdef _PERSONAL_FAME // Arminius 8.30: 家族个人声望
#define MAX_PERSONALFAME 2140000000
#endif
...
enum { SV_PILE, SV_PRICE, SV_INDEX, SV_KIND, SV_USAGE, MAX_SV };
#endif
...
#else
#define CHAR_MAXDEPOTITEMHAVE 30
#endif
...
#define CHAR_MAXITEMHAVE                                                       \
  (CHAR_STARTITEMARRAY + CHAR_MAXITEMNUM * 3) // 咯扁 *3父 眠啊沁澜.

#define CHAR_MAXMAXITEMNUM (CHAR_MAXITEMNUM * 3) // CHAR_MAXITEMNUM 措眉
#define CHAR_MAXMAXITEMHAVE                                                    \
  (CHAR_STARTITEMARRAY + CHAR_MAXMAXITEMNUM) // CHAR_MAXITEMHAVE 措眉
...
typedef enum {
  ...
  CHAR_FUSIONTIMELIMIT, //喂养时间
#endif
#ifdef _PET_FUSION_2
  CHAR_FUSIONTYPE, //融合类型
#endif
#ifdef _PERSONAL_FAME // Arminius 8.30: 家族个人声望
  CHAR_FAME,
#endif
  ...
  CHAR_FAME_REG_TIME,
#endif
  CHAR_SHUALOU_POINT, //刷楼积分
#ifdef _NEW_MAP_NO_FAME
  CHAR_NOFAME,
#endif
  CHAR_RIDENAMEFLG, //骑宠是否显示原名
  ...
  CHAR_RESET, // 檬扁拳 冉荐
  CHAR_BFLV,  //郴备仿 海捞胶 历厘
  CHAR_BFVIT, //郴备仿 海捞胶 历厘
  CHAR_BFSTR, //傍拜仿 海捞胶 历厘
  CHAR_BFTGH, //规绢仿 海捞胶 历厘
  CHAR_BFDEX, //鉴惯仿 海捞胶 历厘
#endif

#ifdef _CHAR_PETDATA
  CHAR_PETDATAH, //檬扁摹 郴备仿 历厘
  CHAR_PETDATAS, //檬扁摹 傍拜仿 历厘
  CHAR_PETDATAT, //檬扁摹 规绢仿 历厘
  CHAR_PETDATAD, //檬扁摹 鉴惯仿 历厘
  CHAR_DATAVIT,  //郴备仿 海捞胶 历厘
  CHAR_DATASTR,  //傍拜仿 海捞胶 历厘
  CHAR_DATATGH,  //规绢仿 海捞胶 历厘
  CHAR_DATADEX,  //鉴惯仿 海捞胶 历厘
  CHAR_DATAALL,  //檬扁摹 海捞胶 历厘
#endif
  ...
  CHAR_CHARMETAMO,     //某腐磐 捞固瘤 历厘
  CHAR_CHARMETAMORIDE, //其飘 捞固瘤 历厘
  CHAR_CHARMETAMONO,   //捞固瘤 历厘 逞滚
  CHAR_BATTLEHP,       // 傈捧 HP悸 窃荐
  CHAR_BATTLEHPUP,     // 傈捧 HP坷抚 箭磊 窃荐
  CHAR_FACEIMAGEDATA,
#endif
#ifdef _CHAR_PARTAUTO
  CHAR_AUTOPARTYINDEX, // 磊悼 颇萍 牢郸胶
  CHAR_LISTPAGE,
#endif
  CHAR_EXTRA_INVENTORY,
...
typedef enum {
  ...
  CHAR_ALLOCPOINT =
      CHAR_LEVELUPPOINT, /* 伊矛伙失永皿凛及喃曰蕊曰禾奶件玄(矢永玄迕) */
...
#ifdef _VERSION_NEW
#define CHAR_FS_WORLD (1 << 8) //职业频道开关
#endif
...
// (可开) Change 替套装增加功能 (_SUIT_ITEM要开)
  ...
  CHAR_WORKUNMPOWER, //抵抗法师的魔法( 受影响的法术:火山泉 火星球 召雷术 电流术
                     //暴风雨 冰箭术 冰爆术 世界末日 火龙枪 嗜血成性 嗜血蛊
                     //一针见血 附身术 )
#endif
#endif //_SUIT_ITEM
...
//*****************************************
...
#ifdef _STREET_VENDOR
  CHAR_WORKSTREETVENDOR, // 摆摊状态
                         // -1:没在摆摊,也没在摆摊交易;1:摆摊中;2:卖方在交易中;3:摆摊的买方
  CHAR_WORKSTREETVENDOR_WHO, // 谁和我交易
#ifdef _MULTI_STREETVENDOR
  CHAR_WORKSTREETVENDOR_TYPE, // 摆摊类型, 1石币, 2声望, 3气势, 4DP, 5积分,
                              // 6金币, 7活力
  CHAR_WORKSTREETVENDOR_TYPE_FLAG, // 预设为0
#endif
#endif
  ...
  CHAR_WORKINTALLSERTALKTIME, //星球频道喊话间隔
#endif
  CHAR_WORK_LISTPAGE,
  ...
  CHAR_NBWORKINT10,
#endif
  CHAR_WORKZOOROOMTIME, //登出消失的动物园时间
#ifdef _NB_SAVEWININDEX
  CHAR_NBWORKWININDX,
#endif
#ifdef _NB_NOBATTLEBUTTON
  CHAR_WORK_NOHELP,   //禁止求救
  CHAR_WORK_NOESCAPE, //禁止逃跑
#endif
#ifdef _NB_GMCHECKEVENT
  CHAR_WORK_GMEVENT, // GM判断获取任务条件
#endif
#ifdef _PETSKILL_ADDATTCRAZED
  CHAR_WORK_ADDATTCRAZED,
  CHAR_WORK_ADDATTCRAZED2,
#endif
...
#ifdef _PRO_KILLME
  CHAR_WORKANGER, //舍身诱敌
  CHAR_WORKANGER_TARGET,
#endif
#ifdef _PRO_ABSOLUTE_DEFENSE //绝对防御
  CHAR_WORK_ABSOLUTE,
  CHAR_WORK_ABSOLUTE2,
#endif
#ifdef _PETSKILL_PROVOKEFIGHT
  CHAR_WORK_PROVOKEFIGHT, //挑畔反击
#endif
#ifdef _PRO3_ADDSKILL
  CHAR_WORK_CRACKBONE,
  CHAR_WORK_CRACKBONE2,
  CHAR_WORK_POISON_DRAGNET,
  CHAR_WORK_PACIFY,
  CHAR_WORK_DARK_SEAL,
  CHAR_WORK_DEMON_SPEECH,
  CHAR_WORK_FIRST_AID,
  CHAR_WORK_ROAR,
  CHAR_WORK_MEDICATION,
  CHAR_WORKDEXICEARROW,
#endif
#ifdef _ITEM_NOENEMY
  CHAR_WORKITEM_NOENEMYONOFF,
  CHAR_WORKITEM_NOENEMYONTIME,
#endif

  CHAR_WORKPARTYLOWDEX,
  CHAR_WORKPARTYHIGHDEX,
#ifdef _ITEM_UPGRADE
  CHAR_WORKUPGRADEITEMINDEX,
  CHAR_WORKUPGRADEINDEX,
#endif
  CHAR_WORKHAVEITEMINDEX,
  CHAR_WORKDATAINTNUM,
...
//) #ifdef _CHAR_PROFESSION #define			CHAR_P_STRING_PROFESSION
//( 1 << 30 ) #endif
...
typedef struct tagChar {
  ...
  int indexOfExistItems[CHAR_MAXMAXITEMHAVE];
...
#define CHAR_CHECKITEMINDEX(charaindex, iindex)                                \
  _CHAR_CHECKITEMINDEX(__FILE__, __LINE__, charaindex, iindex)
BOOL _CHAR_CHECKITEMINDEX(char *file, int line, int charaindex,
                                 int iindex);
#define CHAR_CHECKPETINDEX(petindex)                                           \
  _CHAR_CHECKPETINDEX(__FILE__, __LINE__, petindex)
BOOL _CHAR_CHECKPETINDEX(char *file, int line, int petindex);
#define CHAR_CHECKPOOLPETINDEX(petindex)                                       \
  _CHAR_CHECKPOOLPETINDEX(__FILE__, __LINE__, petindex)
BOOL _CHAR_CHECKPOOLPETINDEX(char *file, int line, int petindex);
#define CHAR_CHECKPETSKILLINDEX(havepetskillindex)                             \
  _CHAR_CHECKPETSKILLINDEX(__FILE__, __LINE__, havepetskillindex)
BOOL _CHAR_CHECKPETSKILLINDEX(char *file, int line,
                                     int havepetskillindex);

// int CHAR_getInt( int index , CHAR_DATAINT element);

#define CHAR_getInt(index, element)                                            \
  _CHAR_getInt(__FILE__, __LINE__, index, element)
...
#define CHAR_setWorkInt(index, element, data)                                  \
  _CHAR_setWorkInt(__FILE__, __LINE__, index, element, data)
...
BOOL _CHAR_getFlg(char *file, int line, int index, CHAR_DATAFLG element);
...
#define CHAR_setItemIndex(index, iindex, id)                                   \
  _CHAR_setItemIndex(__FILE__, __LINE__, index, iindex, id)
int _CHAR_setItemIndex(char *file, int line, int index, int iindex,
                              int id);
#define CHAR_getPoolItemIndex(index, iindex)                                   \
  _CHAR_getPoolItemIndex(__FILE__, __LINE__, index, iindex)
int _CHAR_getPoolItemIndex(char *file, int line, int index, int iindex);
#define CHAR_setPoolItemIndex(index, iindex, id)                               \
  _CHAR_setPoolItemIndex(__FILE__, __LINE__, index, iindex, id)
...
#endif
#define CHAR_getIntPSkill(index, skillti, ti)                                  \
  _CHAR_getIntPSkill(__FILE__, __LINE__, index, skillti, ti)
int _CHAR_getIntPSkill(char *file, int line, int index, int skillti,
                              SKILL_DATAINT ti);

#define CHAR_setIntPSkill(index, skillti, ti, data)                            \
  _CHAR_setIntPSkill(__FILE__, __LINE__, index, skillti, ti, data)
...
#define CHAR_endCharOneArray(index)                                            \
  _CHAR_endCharOneArray(index, __FILE__, __LINE__)
...
#define CHAR_getPetSkillElement(petindex)                                      \
  _CHAR_getPetSkillElement(__FILE__, __LINE__, petindex)
...
#define NB_NEWNAME0 1
#define NB_NEWNAME1 (1 << 1)
#define NB_NEWNAME2 (1 << 2)
#define NB_NEWNAME3 (1 << 3)
#define NB_NEWNAME4 (1 << 4)
#define NB_NEWNAME5 (1 << 5)
#define NB_NEWNAME6 (1 << 6)
#define NB_NEWNAME7 (1 << 7)
#define NB_NEWNAME8 (1 << 8)
#define NB_NEWNAME9 (1 << 9)
#define NB_NEWNAME10 (1 << 10)
#define NB_NEWNAME11 (1 << 11)
#define NB_NEWNAME12 (1 << 12)
#define NB_NEWNAME13 (1 << 13)
#define NB_NEWNAME14 (1 << 14)
#define NB_NEWNAME15 (1 << 15)
#define NB_NEWNAME16 (1 << 16)
#define NB_NEWNAME17 (1 << 17)
#define NB_NEWNAME18 (1 << 19)
#define NB_NEWNAME19 (1 << 18)
#define NB_NEWNAME20 (1 << 20)
#define NB_NEWNAME21 (1 << 21)
#define NB_NEWNAME22 (1 << 22)
#define NB_NEWNAME23 (1 << 23)
#define NB_NEWNAME24 (1 << 24)
#define NB_NEWNAME25 (1 << 25)
#define NB_NEWNAME26 (1 << 26)
#define NB_NEWNAME27 (1 << 27)
#define NB_NEWNAME28 (1 << 28)
#define NB_NEWNAME29 (1 << 29)
#define NB_NEWNAME30 (1 << 30)
#define NB_NEWNAME31 (1 << 31)
...
#ifdef _NB_CHARHALO
#define NB_NEWHALO0 1
#define NB_NEWHALO1 (1 << 1)
#define NB_NEWHALO2 (1 << 2)
#define NB_NEWHALO3 (1 << 3)
#define NB_NEWHALO4 (1 << 4)
#define NB_NEWHALO5 (1 << 5)
#define NB_NEWHALO6 (1 << 6)
#define NB_NEWHALO7 (1 << 7)
#define NB_NEWHALO8 (1 << 8)
#define NB_NEWHALO9 (1 << 9)
#define NB_NEWHALO10 (1 << 10)
#define NB_NEWHALO11 (1 << 11)
#define NB_NEWHALO12 (1 << 12)
#define NB_NEWHALO13 (1 << 13)
#define NB_NEWHALO14 (1 << 14)
#define NB_NEWHALO15 (1 << 15)
#define NB_NEWHALO16 (1 << 16)
#define NB_NEWHALO17 (1 << 17)
#define NB_NEWHALO18 (1 << 19)
#define NB_NEWHALO19 (1 << 18)
#define NB_NEWHALO20 (1 << 20)
#define NB_NEWHALO21 (1 << 21)
#define NB_NEWHALO22 (1 << 22)
#define NB_NEWHALO23 (1 << 23)
#define NB_NEWHALO24 (1 << 24)
#define NB_NEWHALO25 (1 << 25)
#define NB_NEWHALO26 (1 << 26)
#define NB_NEWHALO27 (1 << 27)
#define NB_NEWHALO28 (1 << 28)
#define NB_NEWHALO29 (1 << 29)
#define NB_NEWHALO30 (1 << 30)
#define NB_NEWHALO31 (1 << 31)
...
#define CHAR_DelItemMess(index, ti, flg)                                       \
  _CHAR_DelItem(__FILE__, __LINE__, index, ti, 1, flg)
#define CHAR_DelItem(index, ti)                                                \
  _CHAR_DelItem(__FILE__, __LINE__, index, ti, 1, 1)
#define CHAR_DelPileItemMess(index, ti, num, flg)                              \
  _CHAR_DelItem(__FILE__, __LINE__, index, ti, num, flg)

#define CHAR_AddPileItem(index, itemindex)                                     \
  _CHAR_AddPileItem(__FILE__, __LINE__, index, itemindex)
...
BOOL _CHAR_CHECK_PROFESSION_SKILLINDEX(char *file, int line,
                                              int skillindex);
#define PROFESSION_SKILL_getSkill(charaindex, skillindex)                      \
  _PROFESSION_SKILL_getSkill(__FILE__, __LINE__, charaindex, skillindex)
int _PROFESSION_SKILL_getSkill(char *file, int line, int charaindex,
                                      int skillindex);
#define PROFESSION_SKILL_setSkill(charaindex, skillindex, n)                   \
  _PROFESSION_SKILL_setSkill(__FILE__, __LINE__, charaindex, skillindex, n)
int _PROFESSION_SKILL_setSkill(char *file, int line, int charaindex,
                                      int skillindex, int new);
#define PROFESSION_SKILL_getSkillElement(charaindex)                           \
  _PROFESSION_SKILL_getSkillElement(__FILE__, __LINE__, charaindex)
...
#define CHAR_getDepotItemIndex(index, iindex)                                  \
  _CHAR_getDepotItemIndex(__FILE__, __LINE__, index, iindex)
int _CHAR_getDepotItemIndex(char *file, int line, int index, int iindex);
#define CHAR_setDepotItemIndex(index, iindex, id)                              \
  _CHAR_setDepotItemIndex(__FILE__, __LINE__, index, iindex, id)
...
#define CHAR_getDepotPetIndex(index, iindex)                                   \
  _CHAR_getDepotPetIndex(__FILE__, __LINE__, index, iindex)
int _CHAR_getDepotPetIndex(char *file, int line, int index, int iindex);
#define CHAR_setDepotPetIndex(index, iindex, id)                               \
  _CHAR_setDepotPetIndex(__FILE__, __LINE__, index, iindex, id)
...
#endif
typedef struct tagLeaderBot {
  int Index[1024];
  int Count;
} LeaderBot;
extern LeaderBot Bot;
#endif

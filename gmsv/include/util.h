...
#define SETSECONDVALUE(x, y) ((x) = (((x)&0xffff00ff) | (((y) << 8) & 0x0000ff00)))
#define SETTHIRDVALUE(x, y) ((x) = (((x)&0xff00ffff) | (((y) << 16) & 0x00ff0000)))
#define SETFOURTHVALUE(x, y) ((x) = (((x)&0x00ffffff) | (((y) << 24) & 0xff000000)))

#define MAKE4VALUE(a, b, c, d) ((((a) << 24) & 0xff000000) | (((b) << 16) & 0x00ff0000) | (((c) << 8) & 0x0000ff00) | ((d)&0x000000ff))

...
void ITEM_DeleteByWatched(int myobjindex, int moveobjindex, CHAR_ACTION act, int x, int y, int dir, int *opt, int optlen);
void ITEM_DeleteTimeWatched(int myobjindex, int moveobjindex, CHAR_ACTION act, int x, int y, int dir, int *opt, int optlen);
...
#endif
#ifdef _ITEM_NOENEMY
void ITEM_NoEnemyOnOff(int charaindex, int toindex, int haveitemindex);
#endif
...
void ITEM_RandBox(int charaindex, int toindex, int haveitemindex);
#endif

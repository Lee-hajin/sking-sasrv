...
int CHAR_addItemToChar(int charaindex, Char *ch, int itemid);
...
#ifdef _CHAR_PARTY
void CHAR_PartyLeader(int charindex, int tagetindex);
#endif
...
typedef enum
{
	WINDOW_MESSAGETYPE_MESSAGE,					//0
	WINDOW_MESSAGETYPE_MESSAGEANDLINEINPUT,		//1
	WINDOW_MESSAGETYPE_SELECT,					//2
	WINDOW_MESSAGETYPE_PETSELECT,				//3
	WINDOW_MESSAGETYPE_PARTYSELECT,				//4
	WINDOW_MESSAGETYPE_PETANDPARTYSELECT,		//5
	WINDOW_MESSAGETYPE_ITEMSHOPMENU,			//6
	WINDOW_MESSAGETYPE_ITEMSHOPMAIN,			//7
	WINDOW_MESSAGETYPE_LIMITITEMSHOPMAIN,		//8
	WINDOW_MESSAGETYPE_PETSKILLSHOP,			//9
	WINDOW_MESSAGETYPE_WIDEMESSAGE,				//10
	WINDOW_MESSAGETYPE_WIDEMESSAGEANDLINEINPUT, //11
	WINDOW_MESSAGETYPE_POOLITEMSHOPMENU,		//12
	WINDOW_MESSAGETYPE_POOLITEMSHOPMAIN,		//13
...
//#endif
	...
	WINDOWS_MESSAGETYPE_DRAGONFUSION = 106,
#endif

#ifdef _CHAR_PARTAUTO
	WINDOW_MESSAGETYPE_PARTAUTO = 110,
#endif
...
typedef enum
{
	...
	CHAR_WINDOWTYPE_ITEM_PET_LOCKED_2,
#endif
	...
	CHAR_WINDOWTYPE_ITETOPLAYERPET,
...
#ifdef _NB_DRAGON_FUSION
	CHAR_WINDOWTYPE_DRAGONFUSION_SELPET = 600,
#endif

#ifdef _ITEM_RESETPET //其飘 檬扁拳 备浇
	CHAR_WINDOWTYPE_RESETPET = 610,
	CHAR_WINDOWTYPE_RESETPETNOMAL = 611,
#endif
#ifdef _ITEM_UPGRADE
	CHAR_WINDOWTYPE_UPGRADEITEM_PAGE1,
	CHAR_WINDOWTYPE_UPGRADEITEM_PAGE2,
	CHAR_WINDOWTYPE_UPGRADEITEM_PAGE3,
	CHAR_WINDOWTYPE_UPGRADEITEM_PAGE4,
	CHAR_WINDOWTYPE_UPGRADEITEM_UPGADE,
	CHAR_WINDOWTYPE_UPGRADEITEM_UPGADE_ATTENTION,
#endif
} CHAR_WINDOWTYPE;

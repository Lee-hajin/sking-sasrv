...
static int getInt(lua_State *L) {
  ...
  const int element = getCharBaseValue(L, 2, ProfessionSkillBaseInt,
                                       arraysizeof(ProfessionSkillBaseInt), 1);
...
static int getChar(lua_State *L) {
  const int index = luaL_checkint(L, 1);
  const int element = getCharBaseValue(L, 2, ProfessionSkillBaseChar,
                                       arraysizeof(ProfessionSkillBaseChar), 1);

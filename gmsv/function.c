...
static CorrespondStringAndFunctionTable correspondStringAndFunctionTable[] = {
    ...
    {{"ITEM_BagSlotExtend"}, ITEM_BagSlotExtend, 0},
    {{"ITEM_Mammoth"}, ITEM_Mammoth, 0},
...
#endif
    {{"ITEM_EvolutionType1"}, ITEM_EvolutionType1, 0},
    ...
    {{"ITEM_transpointeventItem"}, ITEM_transpointeventItem, 0},
#endif
...
#ifdef _ALCHEMIST
    {{"ITEM_useAlchemistPlus"}, ITEM_useAlchemistPlus, 0},
#endif

#ifdef _NB_DRAGON_FUSION
    {{"DragonFusionManInit"}, NPC_DragonFusionManInit, 0},
    {{"DragonFusionManTalked"}, NPC_DragonFusionManTalked, 0},
    {{"DragonFusionManLoop"}, NPC_DragonFusionManLoop, 0},
    {{"DragonFusionManWindowTalked"}, NPC_DragonFusionManWindowTalked, 0},
#endif
#ifdef _ITEM_NOENEMY
    {{"ITEM_NoEnemyOnOff"}, ITEM_NoEnemyOnOff, 0},
#endif
#ifdef _ITEM_UNCONFIRMED
    {{"ITEM_Unconfirmed"}, ITEM_Unconfirmed, 0},
#endif
#ifdef _ITEM_METAMOGET
    {{"ITEM_TotemInstallation"}, ITEM_TotemInstallation, 0},
    {{"ITEM_TotemOut"}, ITEM_TotemOut, 0},
#endif

#ifdef _CHAR_PARTAUTO
    {{"PartyAutoInit"}, NPC_PartyAutoInit, 0},
    {{"PartyAutoTalked"}, NPC_PartyAutoTalked, 0},
    {{"PartyAutoWindowTalked"}, NPC_PartyAutoWindowTalked, 0},
#endif
    {{"ITEM_FamilyBadge"}, ITEM_FamilyBadge, 0},
#ifdef _ITEM_RANDOMBOX
    {{"ITEM_RandBox"}, ITEM_RandBox, 0},
#endif
#ifdef _ITEM_ADDPOINT
    {{"ITEM_AddRP"}, ITEM_AddRP, 0},
    {{"ITEM_AddEvP"}, ITEM_AddEvP, 0},
#endif
#ifdef _ITEM_UPGRADE
    {{"ITEM_useUpgrade"}, ITEM_useUpgrade, 0},
#endif

#ifdef ITEM_AURA_
    {{"ITEM_AttachAura"}, ITEM_AttachAura, 0},
    {{"ITEM_DetachAura"}, ITEM_DetachAura, 0},
#endif

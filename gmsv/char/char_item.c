...
CasinoMapTable casinomap[MAXCASINOMAPNUM] = {
    {7008, 13, 13, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 14, 13, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 15, 13, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 16, 13, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 17, 13, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 13, 14, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 14, 14, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 15, 14, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 16, 14, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 17, 14, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 13, 15, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 14, 15, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 15, 15, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 16, 15, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 17, 15, DICE_BIG, 1, "奴林荤困", 1, 0},
    {7008, 8, 13, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 9, 13, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 10, 13, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 11, 13, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 12, 13, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 8, 14, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 9, 14, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 10, 14, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 11, 14, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 12, 14, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 8, 15, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 9, 15, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 10, 15, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 11, 15, DICE_SMALL, 1, "累篮林荤困", 1, 0},
    {7008, 12, 15, DICE_SMALL, 1, "累篮林荤困", 1, 0},

    {7005, 22, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 23, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 24, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 25, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 26, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 27, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 28, 21, PET_RACE1, 1, "1锅 其飘饭捞胶", 2, 0},
    {7005, 22, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 23, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 24, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 25, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 26, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 27, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 28, 24, PET_RACE2, 1, "2锅 其飘饭捞胶", 2, 0},
    {7005, 22, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},
    {7005, 23, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},
    {7005, 24, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},
    {7005, 25, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},
    {7005, 26, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},
    {7005, 27, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},
    {7005, 28, 27, PET_RACE3, 1, "3锅 其飘饭捞胶", 2, 0},

    {7003, 21, 15, ROULETTE1, 1, "逢房饭靛１", 1, 0},
    {7003, 17, 15, ROULETTE3, 1, "逢房饭靛３", 1, 0},
    {7003, 13, 15, ROULETTE5, 1, "逢房饭靛５", 1, 0},
    {7003, 21, 21, ROULETTE6, 1, "逢房饭靛６", 1, 0},
    {7003, 17, 21, ROULETTE8, 1, "逢房饭靛８", 1, 0},
    {7003, 15, 21, ROULETTE9, 1, "逢房饭靛９", 1, 0},
    {7003, 13, 21, ROULETTE10, 1, "逢房饭靛１０", 1, 0},
    {7003, 13, 18, ROULETTE13, 1, "逢房饭靛１３", 1, 0},
    {7003, 9, 21, ROULETTE17, 1, "逢房饭靛１７", 1, 0},
    {7003, 21, 18, ROULETTE18, 1, "逢房饭靛１８", 1, 0},

    {7003, 19, 15, ROULETTE22, 1, "逢房弊赴２", 1, 0},
    {7003, 15, 15, ROULETTE24, 1, "逢房弊赴４", 1, 0},
    {7003, 19, 21, ROULETTE27, 1, "逢房弊赴７", 1, 0},
    {7003, 11, 15, ROULETTE31, 1, "逢房弊赴１１", 1, 0},
    {7003, 9, 15, ROULETTE32, 1, "逢房弊赴１２", 1, 0},
    {7003, 11, 18, ROULETTE34, 1, "逢房弊赴１４", 1, 0},
    {7003, 9, 18, ROULETTE35, 1, "逢房弊赴１５", 1, 0},
    {7003, 11, 21, ROULETTE36, 1, "逢房弊赴１６", 1, 0},
    {7003, 19, 18, ROULETTE39, 1, "逢房弊赴１９", 1, 0},
    {7003, 17, 18, ROULETTE40, 1, "逢房弊赴２０", 1, 0},
    {7003, 17, 24, ROULETTE41, 1, "逢房弊赴", 1, 0},
    {7003, 16, 24, ROULETTE41, 1, "逢房弊赴", 1, 0},
    {7003, 17, 25, ROULETTE41, 1, "逢房弊赴", 1, 0},
    {7003, 16, 25, ROULETTE41, 1, "逢房弊赴", 1, 0},
    {7003, 14, 24, ROULETTE42, 1, "逢房弊赴", 1, 0},
    {7003, 13, 24, ROULETTE42, 1, "逢房弊赴", 1, 0},
    {7003, 14, 25, ROULETTE42, 1, "逢房弊赴", 1, 0},
    {7003, 13, 25, ROULETTE42, 1, "逢房弊赴", 1, 0},

    // WON ADD 修正地图上单双的错误
    {7003, 11, 24, ROULETTE43, 1, "逢房饭靛", 1, 0},
    {7003, 10, 24, ROULETTE43, 1, "逢房饭靛", 1, 0},
    {7003, 11, 25, ROULETTE43, 1, "逢房饭靛", 1, 0},
    {7003, 10, 25, ROULETTE43, 1, "逢房饭靛", 1, 0},
    {7003, 20, 24, ROULETTE44, 1, "逢房弊赴", 1, 0},
    {7003, 19, 24, ROULETTE44, 1, "逢房弊赴", 1, 0},
    {7003, 20, 25, ROULETTE44, 1, "逢房弊赴", 1, 0},
    {7003, 19, 25, ROULETTE44, 1, "逢房弊赴", 1, 0},

    {7003, 20, 15, (ROULETTE1 << 16) + ROULETTE22, 1, "逢房饭靛１弊赴２", 1, 0},
    {7003, 18, 15, (ROULETTE3 << 16) + ROULETTE22, 1, "逢房饭靛３弊赴２", 1, 0},
    {7003, 16, 15, (ROULETTE3 << 16) + ROULETTE24, 1, "逢房饭靛３弊赴４", 1, 0},
    {7003, 14, 15, (ROULETTE5 << 16) + ROULETTE24, 1, "逢房饭靛５弊赴４", 1, 0},
    {7003, 12, 15, (ROULETTE5 << 16) + ROULETTE31, 1, "逢房饭靛５弊赴１１", 1,
     0},
    {7003, 10, 15, (ROULETTE32 << 16) + ROULETTE31, 1, "逢房饭靛１２弊赴１１",
     1, 0},

    {7003, 20, 18, (ROULETTE18 << 16) + ROULETTE39, 1, "逢房饭靛１８弊赴１９",
     1, 0},
    {7003, 18, 18, (ROULETTE40 << 16) + ROULETTE39, 1, "逢房饭靛２０弊赴１９",
     1, 0},
    {7003, 16, 18, (ROULETTE40 << 16) + ROULETTE45, 1, "逢房饭靛２０弊赴００",
     1, 0},
    {7003, 14, 18, (ROULETTE13 << 16) + ROULETTE45, 1, "逢房饭靛１３弊赴００",
     1, 0},
    {7003, 12, 18, (ROULETTE13 << 16) + ROULETTE34, 1, "逢房饭靛１３弊赴１４",
     1, 0},
    {7003, 10, 18, (ROULETTE35 << 16) + ROULETTE34, 1, "逢房饭靛１５弊赴１４",
     1, 0},

    {7003, 20, 21, (ROULETTE6 << 16) + ROULETTE27, 1, "逢房饭靛６弊赴７", 1, 0},
    {7003, 18, 21, (ROULETTE8 << 16) + ROULETTE27, 1, "逢房饭靛８弊赴７", 1, 0},
    {7003, 16, 21, (ROULETTE8 << 16) + ROULETTE9, 1, "逢房饭靛８饭靛９", 1, 0},
    {7003, 14, 21, (ROULETTE10 << 16) + ROULETTE9, 1, "逢房饭靛１０饭靛９", 1,
     0},
    {7003, 12, 21, (ROULETTE10 << 16) + ROULETTE36, 1, "逢房饭靛１０弊赴１６",
     1, 0},
    {7003, 10, 21, (ROULETTE17 << 16) + ROULETTE36, 1, "逢房饭靛１７弊赴１６",
     1, 0},
    {7003, 8, 15, ROULETTE51, 1, "内胶１", 1, 0}, //横列
    {7003, 8, 18, ROULETTE52, 1, "内胶２", 1, 0},
    {7003, 8, 21, ROULETTE53, 1, "内胶３", 1, 0},
    {7003, 6, 15, ROULETTE61, 1, "锅龋１－１０", 1, 0}, // 1到10
    {7003, 5, 15, ROULETTE61, 1, "锅龋１－１０", 1, 0},
    {7003, 6, 16, ROULETTE61, 1, "锅龋１－１０", 1, 0},
    {7003, 5, 16, ROULETTE61, 1, "锅龋１－１０", 1, 0},
    {7003, 24, 15, ROULETTE62, 1, "锅龋１１－２０", 1, 0}, // 10到11
    {7003, 23, 15, ROULETTE62, 1, "锅龋１１－２０", 1, 0},
    {7003, 24, 16, ROULETTE62, 1, "锅龋１１－２０", 1, 0},
    {7003, 23, 16, ROULETTE62, 1, "锅龋１１－２０", 1, 0},
    {7003, 15, 18, ROULETTE45, 1, "抛捞喉(００)", 1, 0},
...
BOOL CHAR_sendItemData(int charaindex, int *itemgroup, int num) {
  ...
  if (num <= 0 || num > CHAR_getMaxInventory(charaindex))
    return FALSE;
...
static void CHAR_sendItemDetachEvent(int charaindex, int itemindex) {
  ...
  if (ITEM_getInt(itemindex, ITEM_USETIME) > 0) {
    ...
    snprintf(mesg, sizeof(mesg), "卸下%s 有效使用期至 %d年%d月%d日 %d:%d:%d",
             ITEM_getChar(itemindex, ITEM_SECRETNAME), tm1->tm_year + 1900,
...
#endif
  {
    snprintf(mesg, sizeof(mesg), "%s 酒捞袍阑 秦力沁嚼聪促 ",
  ...
  if (!strcmp(ITEM_getChar(itemindex, ITEM_ATTACHFUNC),
              "ITEM_TotemInstallation") &&
      CHAR_getWorkInt(charaindex, CHAR_CHARMETAMONO) == 1) {
...
#endif
  if (CHAR_getInt(charaindex, CHAR_RIDEPET) != -1) {
    if (!strcmp(ITEM_getChar(itemindex, ITEM_USEFUNC), "ITEM_useRideNo")) {
      CHAR_setInt(charaindex, CHAR_RIDEPET, -1);
      CHAR_setInt(charaindex, CHAR_BASEIMAGENUMBER,
                  CHAR_getInt(charaindex, CHAR_BASEBASEIMAGENUMBER));
      CHAR_complianceParameter(charaindex);
...
#endif
  {
    snprintf(mesg, sizeof(mesg), "%s 酒捞袍阑 馒侩沁嚼聪促. ",
             ITEM_getAppropriateName(itemindex));
  }
...
static int CHAR_findEmptyItemBoxFromChar(int index, Char *ch) {
  int i;

  print("maxiNv:%d\n", CHAR_getMaxInventory(index));
...
int CHAR_findEmptyItemBox(int index) {
  ...
  ch = CHAR_getCharPointer(index);
  if (ch != NULL)
    return CHAR_findEmptyItemBoxFromChar(index, ch);
  else
    return -1;
}
...
#define LACKOFCLASS                                                            \
  {                                                                            \
    CHAR_talkToCli(index, -1,                                                  \
                   "饭骇捞 何练窍咯 酒捞袍 馒侩阑 且 荐 绝嚼聪促。",           \
                   CHAR_COLORWHITE);                                           \
  }
#define CANNOTEQUIP                                                            \
  { CHAR_talkToCli(index, -1, "弊巴阑 馒侩且 荐 绝嚼聪促。", CHAR_COLORRED); }
#define CANNOTEQUIP2                                                           \
  {                                                                            \
    CHAR_talkToCli(index, -1, "鞍篮 辆幅狼 酒捞袍阑 馒侩且 荐 绝嚼聪促。",     \
                   CHAR_COLORRED);                                             \
  }
#define CANNOTEXCHANGE                                                         \
  { CHAR_talkToCli(index, -1, "辑肺 背券且 荐 绝嚼聪促。", CHAR_COLORRED); }
#define CANNOTMOVE                                                             \
  { CHAR_talkToCli(index, -1, "弊犯霸 捞悼且 荐 绝嚼聪促。", CHAR_COLORRED); }
...
static BOOL CHAR_moveItemFromItemBoxToEquip(int index, int fromindex,
  ...
  if (ITEM_getInt(fromid, ITEM_NEEDPROFESSION) != 0) {
    if (CHAR_getInt(index, PROFESSION_CLASS) !=
      ...
      CHAR_talkToCli(index, -1, "该职业无法装备此物品！", CHAR_COLORYELLOW);
      return FALSE;
    }
  }
#endif
  ...
  if (ITEM_getInt(fromid, ITEM_ID) == ANGELITEM) {
    ...
    if (mindex < 0 ||
      ...
      CHAR_talkToCli(index, -1, "这并不是属於你的信物，无法装备。",
                     CHAR_COLORYELLOW);
      return FALSE;
    }
  }
...
BOOL CHAR_PileItemFromItemBoxToItemBox(int charaindex, int fromindex,
                                       int toindex) {
...
int CHAR_getMaxInventory(int charaindex) {
  return min(CHAR_STARTITEMARRAY + CHAR_MAXITEMNUM +
                 CHAR_MAXITEMNUM *
                     CHAR_getInt(charaindex, CHAR_EXTRA_INVENTORY),
             CHAR_MAXMAXITEMHAVE);
}
...
#define MOVEITEM_ITEMTOITEM 1 << 2
  ...
  while (1) {
    ...
    if (CHAR_getFlg(index, CHAR_ISDIE))
      break;
    if (fromindex < 0 || fromindex >= CHAR_getMaxInventory(index) ||
        toindex < 0 || toindex >= CHAR_getMaxInventory(index))
      break;
...
int CHAR_addItemToChar(int index, Char *ch, int itemid) {
  int itembox;
  itembox = CHAR_findEmptyItemBoxFromChar(index, ch);
  if (itembox == -1)
    return -1;
...
int CHAR_addItem(int charaindex, int itemid) {
  ...
  if (ch != NULL) {
    int ret = CHAR_addItemToChar(charaindex, ch, itemid);
    if (ret == -1)
      return ret;
...
void CHAR_ItemUse(int charaindex, int to_charaindex, int haveitemindex) {
    ...
    if (ep == CHAR_DECORATION1) {
      ...
      if (searchindex != -1) {
        if (fromitemtype != ITEM_getInt(searchindex, ITEM_TYPE)) {
          flg = TRUE;
          ep = (searchindex == toitemindex1) ? CHAR_DECORATION2
                                             : CHAR_DECORATION1;
        }
      }
      if (!flg) {
  ...
  usefunc =
      (void (*)(int, int, int))ITEM_getFunctionPointer(itemindex, ITEM_USEFUNC);

  if (usefunc) {
    {
      LogItem(CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿o */
              CHAR_getChar(charaindex, CHAR_CDKEY), itemindex, "使用道具",
...
#ifdef _ALLBLUES_LUA_1_2
    if (RunItemUseEvent(itemindex, charaindex, to_charaindex, haveitemindex) ==
        FALSE)
#endif
    {
      char ansmsg[256];
...
BOOL CHAR_DropItemFXY(int charaindex, int itemcharaindex, int fl, int x, int y,
                      int *objindex) {
  int itemindex;
    ...
    *objindex = CHAR_DropItemAbsolute(itemindex, fl, x, y, FALSE);
      ...
      return -3;
    {
      LogItem(CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿   */
              CHAR_getChar(charaindex, CHAR_CDKEY), itemindex, "丢出道具",
              CHAR_getInt(charaindex, CHAR_FLOOR),
              CHAR_getInt(charaindex, CHAR_X), CHAR_getInt(charaindex, CHAR_Y),
              ITEM_getChar(itemindex, ITEM_UNIQUECODE),
              ITEM_getChar(itemindex, ITEM_NAME),
...
void CHAR_SendDropItem_Stats(int charaindex, int itemindex, int itemcharaindex,
                             int flg) {
  if (flg == 1) {
  ...
  if (0 <= itemcharaindex && itemcharaindex < CHAR_STARTITEMARRAY &&
      CHAR_getInt(charaindex, CHAR_WHICHTYPE) ==
          CHAR_TYPEPLAYER) { //如果丢弃物为装备
    if (ITEM_CHECKINDEX(itemindex))
      CHAR_sendItemDetachEvent(charaindex, itemindex);

    CHAR_send_P_StatusString(
        charaindex, CHAR_P_STRING_HP | CHAR_P_STRING_MAXHP | CHAR_P_STRING_MP |
...
#ifdef _DROPSTAKENEW
void CHAR_DropStakeByDropItem(int charaindex, int itemcharaindex, int itemindex,
                              int fl, int x, int y) {
  ...
  LogItem(CHAR_getChar(charaindex, CHAR_NAME),
          CHAR_getChar(charaindex, CHAR_CDKEY), itemindex, "丢出彩券",
...
BOOL CHAR_FindAroundUsabilitySpace(int charaindex, int itemindex, int *fl,
                                   int *x, int *y) {
  int dropx, dropy, i;
  BOOL Find = FALSE;
  ...
  for (i = 0; i < 8; i++) {
    OBJECT object;
    Find = FALSE;
    dropx = CHAR_getInt(charaindex, CHAR_X) +
            CHAR_getDX(CHAR_getInt(charaindex, CHAR_DIR) + i);
    dropy = CHAR_getInt(charaindex, CHAR_Y) +
            CHAR_getDY(CHAR_getInt(charaindex, CHAR_DIR) + i);
...
void CHAR_DropItem(int charaindex, int itemcharaindex) {
  ...
  if (CHAR_getWorkInt(charaindex, CHAR_WORKBATTLEMODE) !=
      BATTLE_CHARMODE_NONE) {
    CHAR_talkToCli(charaindex, -1, "傈捧 吝俊绰 酒捞袍阑 滚副 荐 绝绢夸",
                   CHAR_COLORYELLOW);
    return;
  }
#ifdef _AVID_TRADETRYBUG //丢道具装备
  if (CHAR_getWorkInt(charaindex, CHAR_WORKTRADEMODE) != CHAR_TRADE_FREE) {
    CHAR_talkToCli(charaindex, -1, "背券 惑怕俊辑绰 酒捞袍阑 滚副 荐 绝绢夸",
                   CHAR_COLORYELLOW);
    return;
  }
#endif
  ...
  if (ITEM_getInt(itemindex, ITEM_ItemLock) == 1) {
    ...
    sprintf(
        ...
        "\n",
        ITEM_getChar(itemindex, ITEM_NAME));
    CHAR_setWorkInt(charaindex, CHAR_WORK_TIMER, itemcharaindex);
  ...
  if (FreeDropItem(charaindex, itemindex) == 0) {
    return;
  }
#endif
  ...
  if (ITEM_getInt(itemindex, ITEM_ID) == CASINOTOKENID &&
    ...
    dropx = CHAR_getInt(charaindex, CHAR_X) +
            CHAR_getDX(CHAR_getInt(charaindex, CHAR_DIR));
    dropy = CHAR_getInt(charaindex, CHAR_Y) +
            CHAR_getDY(CHAR_getInt(charaindex, CHAR_DIR));
    CHAR_DropStakeByDropItem(charaindex, itemcharaindex, itemindex, dropfl,
                             dropx, dropy);
    return;
  }
  //找出周围空间
  if (CHAR_FindAroundUsabilitySpace(charaindex, itemindex, &fl, &x, &y) ==
      FALSE) {
    CHAR_talkToCli(charaindex, -1, "林函俊 酒捞袍捞 腹酒辑 滚副荐 绝嚼聪促。",
                   CHAR_COLORYELLOW);
    return;
  }
  ...
  if (ret == 1) { //-1 物品不存在 1 消失 0 一般物品
    ...
    {
      char tmpbuf[256];
      sprintf(tmpbuf, "酒捞袍 [%s](捞)啊 [%d]檬 饶俊 荤扼笼聪促",
              ITEM_getChar(itemindex, ITEM_NAME), getItemdeletetime());
      CHAR_talkToCli(charaindex, -1, tmpbuf, CHAR_COLORYELLOW);
      LogItem(CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿   */
              CHAR_getChar(charaindex, CHAR_CDKEY), itemindex,
              "Drop(酒捞袍滚覆)", CHAR_getInt(charaindex, CHAR_FLOOR),
              CHAR_getInt(charaindex, CHAR_X), CHAR_getInt(charaindex, CHAR_Y),
              ITEM_getChar(itemindex, ITEM_UNIQUECODE),
              ITEM_getChar(itemindex, ITEM_NAME),
              ITEM_getInt(itemindex, ITEM_ID), charaindex);
...
void CHAR_DropItem(int charaindex, int itemcharaindex) {
  ...
  floor = CHAR_getInt(charaindex, CHAR_FLOOR);
  {
    int ret;
    if (0 <= itemcharaindex &&
        itemcharaindex < CHAR_STARTITEMARRAY) { //如果丢弃物为装备
      CHAR_sendItemDetachEvent(charaindex, itemindex);
    }
    ret = ITEM_eventDrop(itemindex, charaindex, itemcharaindex);
    if (ret == 1) { //-1 物品不存在 1 消失 0 一般物品
  ...
  for (i = 0; i < 9; i++) {
    ...
    if (ITEM_getInt(itemindex, ITEM_ID) == CASINOTOKENID) {
      ...
      for (j = 0; j < arraysizeof(casinomap); j++) {
        if (CHAR_getInt(charaindex, CHAR_FLOOR) == casinomap[j].casinofl) {
          if (x == casinomap[j].casinox && y == casinomap[j].casinoy) {
            ...
            casinoflag = 1;
            if (casinomap[j].dropflag == 0) {
              CHAR_talkToCli(charaindex, -1, "海泼阑 且 荐 绝嚼聪促！",
                             CHAR_COLORYELLOW);
              return;
            } else {
      ...
      if (bdropstake == 0 && casinoflag != 0) {
        ...
        LogItem(CHAR_getChar(charaindex, CHAR_NAME),
                CHAR_getChar(charaindex, CHAR_CDKEY), itemindex,
                "StakeDrop(汗鼻滚覆)", CHAR_getInt(charaindex, CHAR_FLOOR),
...
#endif
    {
      int ret = CHAR_DropItemFXY(charaindex, itemcharaindex,
                                 CHAR_getInt(charaindex, CHAR_FLOOR), x, y,
                                 &objindex);
      switch (ret) {
      case 0:
        droped = 1;
...
int CHAR_addItemSpecificItemIndex(int charaindex, int itemindex) {
  ...
  print("emptyindex:%d\n", emptyindex);
  if (emptyindex == -1) {
    return CHAR_getMaxInventory(charaindex);
  } else {
    ...
    if (objtype == OBJTYPE_NOUSE)
      ...
      if (strcmp(getItemup(), "否") == 0) {
        if (strcmp(ITEM_getChar(itemindex, ITEM_CDKEY),
          ...
          if (ITEM_getInt(itemindex, ITEM_ID) != 12808 &&
              ITEM_getInt(itemindex, ITEM_ID) != 2400 &&
              ITEM_getInt(itemindex, ITEM_ID) != 2174) {
            CHAR_talkToCli(charaindex, -1, "【温馨提示】别人丢的东西不能捡哦！",
                           CHAR_COLORYELLOW);
            return -6;
          }
        }
      ...
      if (ITEM_getInt(itemindex, ITEM_ID) == CASINOTOKENID) {
        ...
        for (i = 0; i < arraysizeof(casinomap); i++) {
          if (fl == casinomap[i].casinofl) {
            if (x == casinomap[i].casinox && y == casinomap[i].casinoy) {
              ...
              if (stakeflag == 0) {
                CHAR_talkToCli(charaindex, -1,
                               "寸脚篮 海泼茄 酒捞袍捞 粮犁窍瘤 臼嚼聪促！",
                               CHAR_COLORYELLOW);
                return -1;
              }
              for (j = 0; j < MAXSTAKENUM; j++) {
                if (CHAR_getWorkInt(charaindex, CHAR_WORKSTAKETYPE1 + j) ==
              ...
              if (stakeflag < 0) {
                ...
                CHAR_setWorkInt(charaindex, CHAR_WORKSTAKEFLAG, stakeflag);
              if (pickupflag == 0) {
                CHAR_talkToCli(charaindex, -1, "海泼阑 窍脚 郴开捞 绝嚼聪促！",
                               CHAR_COLORYELLOW);
                return -1;
              }
            }
        ...
        if (bdropstake == 0 &&
          ...
          LogItem(
              CHAR_getChar(charaindex, CHAR_NAME),
              CHAR_getChar(charaindex, CHAR_CDKEY), itemindex,
              "StakePickUp(汗鼻阑凛促)", CHAR_getInt(charaindex, CHAR_FLOOR),
              CHAR_getInt(charaindex, CHAR_X), CHAR_getInt(charaindex, CHAR_Y),
              ITEM_getChar(itemindex, ITEM_UNIQUECODE),
              ITEM_getChar(itemindex, ITEM_NAME),
              ITEM_getInt(itemindex, ITEM_ID), charaindex);
      ...
      print("ret2:%d\n", ret);
      if (ret == CHAR_getMaxInventory(charaindex)) {
        return -2;
      } else if (ret != -1) {
        typedef void (*PICKUPFUNC)(int, int);
        PICKUPFUNC pickupfunc = NULL;
        pickupfunc =
            (PICKUPFUNC)ITEM_getFunctionPointer(itemindex, ITEM_PICKUPFUNC);
        if (pickupfunc) {
      ...
      newamountgold =
          (unsigned int)CHAR_getInt(charaindex, CHAR_GOLD) + dropgoldamount;
      ...
      *objindex = index;
      ...
      if (CHAR_getInt(pindex, CHAR_WHICHTYPE) == CHAR_TYPEPET) {
        ...
        if (CHAR_getWorkInt(charaindex, CHAR_PickAllPet) != TRUE) {
          if ((CHAR_getInt(pindex, CHAR_LV) - CHAR_getInt(charaindex, CHAR_LV) >
               5) &&
...
void CHAR_PickUpItem(int charaindex, int dir) {
  ...
  for (i = 0; i < searchloopcount; i++) {
    ...
    case 0:
      CHAR_ObjectDelete(objindex);
      {
        ...
        if (ITEM_getInt(contents, ITEM_ID) == CASINOTOKENID && dropflag == 1)
          snprintf(mesg, sizeof(mesg),
                   "海泼篮 捞固 秒家登菌嚼聪促.%s 酒捞袍阑 倒妨罐嚼聪促！",
                   ITEM_getAppropriateName(contents));
        else
#endif
          snprintf(mesg, sizeof(mesg), "%s(阑)甫 林奎绢夸",
                   ITEM_getAppropriateName(contents));
        CHAR_talkToCli(charaindex, -1, mesg, CHAR_COLORWHITE);
      }
      ...
      {
        LogItem(CHAR_getChar(charaindex, CHAR_NAME),
                CHAR_getChar(charaindex, CHAR_CDKEY), contents,
                "PickUp(酒捞袍凛促)", CHAR_getInt(charaindex, CHAR_FLOOR),
                CHAR_getInt(charaindex, CHAR_X),
                CHAR_getInt(charaindex, CHAR_Y),
                ITEM_getChar(contents, ITEM_UNIQUECODE),
                ITEM_getChar(contents, ITEM_NAME),
                ITEM_getInt(contents, ITEM_ID), charaindex);
      }
    ...
    case 1:
      ...
      }
      {
        char mesg[256];
        if (contents == 0) {
          snprintf(mesg, sizeof(mesg), "家瘤窍绊乐绰 胶沛捞 呈公 腹嚼聪促。");
        } else {
          snprintf(mesg, sizeof(mesg), "%d 胶沛阑 林奎嚼聪促。", contents);
        }
        CHAR_talkToCli(charaindex, -1, mesg, CHAR_COLORWHITE);
      }
      if (contents != 0) {
        LogStone(-1, CHAR_getChar(charaindex, CHAR_NAME),
                 CHAR_getChar(charaindex, CHAR_CDKEY), contents,
                 CHAR_getInt(charaindex, CHAR_GOLD), "PickUp(裙垫窍促)",
                 CHAR_getInt(charaindex, CHAR_FLOOR),
                 CHAR_getInt(charaindex, CHAR_X),
                 CHAR_getInt(charaindex, CHAR_Y));
      }
    ...
    case 2: //宠物
      ...
      CHAR_setWorkInt(contents, CHAR_WORKOBJINDEX, -1);
      {
        ...
        snprintf(mesg, sizeof(mesg), "%s(阑)甫 林奎嚼聪促。", p);
        CHAR_talkToCli(charaindex, -1, mesg, CHAR_COLORWHITE);
      }
      // 矢永玄毛胶匀凶夫弘
      SQL_UpdatePetRank(contents);
      LogPet(CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿   */
             CHAR_getChar(charaindex, CHAR_CDKEY),
             CHAR_getChar(contents, CHAR_NAME), CHAR_getInt(contents, CHAR_LV),
             "PickUp(裙垫窍促)", CHAR_getInt(charaindex, CHAR_FLOOR),
             CHAR_getInt(charaindex, CHAR_X), CHAR_getInt(charaindex, CHAR_Y),
             CHAR_getChar(contents, CHAR_UNIQUECODE), contents, charaindex);
      return;
      break;
    ...
    case 3:
      ...
      // 矢永玄毛胶匀凶夫弘
      SQL_DeletePetInRank(contents);
      LogPet(CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿   */
             CHAR_getChar(charaindex, CHAR_CDKEY),
             CHAR_getChar(contents, CHAR_NAME), CHAR_getInt(contents, CHAR_LV),
             "FollowPickUp(裙垫窍促)", CHAR_getInt(charaindex, CHAR_FLOOR),
             CHAR_getInt(charaindex, CHAR_X), CHAR_getInt(charaindex, CHAR_Y),
             CHAR_getChar(contents, CHAR_UNIQUECODE), contents, charaindex);
    ...
    case -1:
      break;
    case -2:
      CHAR_talkToCli(charaindex, -1, "酒捞袍捞 啊垫 谩嚼聪促。", CHAR_COLORRED);
      break;
    case -3:
      CHAR_talkToCli(charaindex, -1, "其飘啊 啊垫 瞒辑 林匡 荐 绝嚼聪促。",
                     CHAR_COLORRED);
      break;
    case -4:
      CHAR_talkToCli(charaindex, -1, "饭骇捞 撤酒 其飘甫 林匡 荐 绝嚼聪促。",
                     CHAR_COLORRED);
      break;
    case -5:
      CHAR_talkToCli(charaindex, -1, "捞 其飘绰 林匡 荐 绝嚼聪促。",
                     CHAR_COLORRED);
      break;
    case -6:
      CHAR_talkToCli(charaindex, -1, "酒捞袍阑 林快角 荐 绝嚼聪促.",
                     CHAR_COLORRED);
      break;
    default:
      return;
 ...
 *  岳      0
 ------------------------------------------------------------*/
static BOOL CHAR_DropMoneyFXY(int charaindex, int amount, int fl, int x, int y,
      ...
      *objindex = index;
      ...
      if (amount >= 100) { /* 云嗯毛  中凶夫弘 */
        LogStone(-1, CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿   */
                 ...
                 amount,                                  /* 嗯喊 */
                 CHAR_getInt(charaindex, CHAR_GOLD), "Drop(酒捞袍滚覆)",
                 CHAR_getInt(charaindex, CHAR_FLOOR),
                 CHAR_getInt(charaindex, CHAR_X),
                 CHAR_getInt(charaindex, CHAR_Y));
      }
...
void CHAR_DropMoney(int charaindex, int amount) {
  ...
  if (CHAR_getWorkInt(charaindex, CHAR_WORKTRADEMODE) == CHAR_TRADE_TRADING) {
    CHAR_talkToCli(charaindex, -1, "背券 惑怕俊辑绰 胶沛阑 滚副 荐 绝嚼聪促。",
                   CHAR_COLORYELLOW);
    return;
  }
#endif
#ifdef _ALLBLUES_LUA_1_9
  if (FreeDropGold(charaindex, amount) == 0) {
    return;
  }
#endif
  MaxGold = CHAR_getMaxHaveGold(charaindex);
...
// CoolFish 2002/04/06 下注处不可丢置石币
#ifdef _DROPSTAKENEW
    {
      ...
      for (j = 0; j < arraysizeof(casinomap); j++) {
        if (CHAR_getInt(charaindex, CHAR_FLOOR) == casinomap[j].casinofl) {
          if (x == casinomap[j].casinox && y == casinomap[j].casinoy) {
            CHAR_talkToCli(charaindex, -1, "咯扁俊绰 硅摹且 荐 绝嚼聪促！",
                           CHAR_COLORYELLOW);
            return;
          }
        }
    ...
    ret = CHAR_DropMoneyFXY(charaindex, amount,
                            CHAR_getInt(charaindex, CHAR_FLOOR), x, y, FALSE,
                            &objindex);
    switch (ret) {
    case 0:
      goto END;
...

  {
    ...
    ret = CHAR_DropMoneyFXY(charaindex, amount,
                            CHAR_getInt(charaindex, CHAR_FLOOR), x, y, TRUE,
                            &objindex);
    switch (ret) {
    case 0:
      goto END;
...
static int CHAR_findEmptyItemBoxNoFromChar(Char *ch) {
  int i, j = 0;
  ;
  for (i = CHAR_STARTITEMARRAY; i < CHAR_MAXMAXITEMHAVE; i++) {
    int itemindex;
    itemindex = ch->indexOfExistItems[i];
    if (itemindex == -1)
      j++;
...
int CHAR_pickupFollowPet(int charaindex, int pickupindex) {
  ...
  if ((pickupindex == -1) ||
      (pickupindex == CHAR_getWorkInt(charaindex, CHAR_WORKPETFOLLOW)))
    CHAR_setWorkInt(charaindex, CHAR_WORKPETFOLLOW, -1);
  ...
  LogPet(CHAR_getChar(charaindex, CHAR_NAME), /* 平乓仿   */
         ...
         "FollowPickUp(其飘凛促)", CHAR_getInt(charaindex, CHAR_FLOOR),
         CHAR_getInt(charaindex, CHAR_X), CHAR_getInt(charaindex, CHAR_Y),
...
int CasinoAccumulation(int charindex, int npcindex, int floor,
  ...
  snprintf(tmpbuf, sizeof(tmpbuf), "档钦[%4d] 器牢飘 利赋", accumulation);
...
void CHAR_movePetItem(int charaindex, int petid, int fromindex, int toindex) {
  ...
  if (toindex == -1 && fromindex >= CHAR_EQUIPPLACENUM &&
      fromindex < CHAR_getMaxInventory(charaindex)) {
    ...
    if (fromindex < CHAR_PETITEMNUM) {
      CHAR_talkToCli(charaindex, -1, "其飘厘馒 酒捞袍篮 滚府角 荐 绝嚼聪促。",
                     CHAR_COLORYELLOW);
    } else {
#ifdef _NB_CDKEYLOCK
  ...
  if ((fromindex >= 0 && fromindex < CHAR_PETITEMNUM &&
       ...
       toindex < CHAR_getMaxInventory(charaindex)) ||
    ...
    if (fromindex >= CHAR_EQUIPPLACENUM) {
      ...
      if(CHAR_getInt(petindex, CHAR_VARIABLEAI) < 100){
              CHAR_talkToCli( charaindex, -1, "弊巴阑 其飘啊 馒侩且 荐
      绝嚼聪促。", CHAR_COLORRED ); return;
      }
      */
#ifdef _NB_LUA_MovePetItem
      //玩家索引,宠物索引,道具索引,宠装索引,道具位置,装备位置
      if (FreeMovePetItem(charaindex, petindex, charitemindex, petitemindex,
                          fromindex, toindex) == 0) {
        return;
      }
#endif
      if (type < ITEM_PET_HEAD || type > ITEM_PET_FEET ||
        ...
        CHAR_talkToCli(charaindex, -1, "弊巴阑 馒侩且 荐 绝嚼聪促。",
                       CHAR_COLORWHITE);
        return;
      }
      if (CHAR_getInt(petindex, CHAR_LV) <
          ITEM_getInt(charitemindex, ITEM_LEVEL)) {
        CHAR_talkToCli(charaindex, -1, "其飘啊 馒侩窍扁俊 饭骇捞 何练钦聪促！",
                       CHAR_COLORYELLOW);
        return;
      }
      if (ITEM_CHECKINDEX(petitemindex)) {
        sprintf(token, "宠物%s 卸下%s", CHAR_getChar(petindex, CHAR_NAME),
                ITEM_getChar(petitemindex, ITEM_NAME));
        CHAR_talkToCli(charaindex, -1, token, CHAR_COLORWHITE);
      }
      sprintf(token, "宠物%s 装备%s", CHAR_getChar(petindex, CHAR_NAME),
              ITEM_getChar(charitemindex, ITEM_NAME));
      CHAR_talkToCli(charaindex, -1, token, CHAR_COLORWHITE);
      ...
      if (ITEM_CHECKINDEX(charitemindex)) {
        ...
        if(CHAR_getInt(petindex, CHAR_VARIABLEAI) < 100){
                CHAR_talkToCli( charaindex, -1,
        "无法训服宠物装备该物品(忠诚不足)。", CHAR_COLORRED ); return;
        }
        if (CHAR_getInt( charaindex, CHAR_RIDEPET ) == petid ){
                CHAR_talkToCli( charaindex, -1, "骑乘中的宠无法装备该物品。",
        CHAR_COLORRED ); return;
        }
        */
#ifdef _NB_LUA_MovePetItem
        //玩家索引,宠物索引,道具索引,宠装索引,道具位置,装备位置
        ...
        if (CHAR_getInt(petindex, CHAR_LV) <
            ITEM_getInt(charitemindex, ITEM_LEVEL)) {
          CHAR_talkToCli(charaindex, -1, "宠物等级尚未到达装备该项物品！",
                         CHAR_COLORYELLOW);
          return;
        }
        sprintf(token, "宠物%s 装备%s", CHAR_getChar(petindex, CHAR_NAME),

...
static int EVENT_onWarpNPC(int charaindex, int echaraindex, int fl, int x,
                           int y);
static int EVENY_npcEncount(int charaindex, int echaraindex, int fl, int x,
                            int y);
...
int EVENT_main(int charaindex, int event, int x, int y) {
  ...
  /*
          if( !found ) {
                  print( "not found eventobject : cind [%d] event [%d] fl[%d]

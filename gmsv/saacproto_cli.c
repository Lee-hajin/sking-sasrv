...
/*
90 :   <LI>  <a name="ACServerLoginC"><font color=red>clienttoserver
ACServerLogin(string servername,string serverpas);<br></font></a> 91 :
必□丞扔□田□互失市它件玄扔□田□卞夫弘奶件允月午五卞银丹［ 92 :
涛粮毛舰匀凶丐午｝仇及夫弘奶件毛仄卅中午允屯化及扔□申旦毛仄卅中［ 93 : <br><br>
94 :      <dl>
...
void saacproto_UpdataStele_send(int fd, char *cdkey, char *name, char *title,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(cdkey),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(name),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(title),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(level),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(trns),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(time),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(floor),
                       saacproto.workbufsize);
...
void saacproto_ACServerLogin_send(int fd, char *servername, char *serverpas) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(servername),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(serverpas),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
/*
114 : <LI><a name="ACServerLogoutC"><font color=red>clienttoserver
ACServerLogout(void);<br></font></a> 115 :
扔□田□互失市它件玄扔□田□井日夫弘失它玄允月午五卞银丹［ 116 : 涛粮反扔□田卞方匀化
澎卞濠日木月［仄凶互匀化仇木卞覆允月失市它件玄扔□田 117 :
及忒蚕反戊生弁扑亦件毛濠月仪匹丐月［ 118 :      <br> 119 :      <br> 120 : <br>
121 :
122 :
*/
...
void saacproto_ACCharList_send(int fd, char *id, char *pas, int mesgid,
                               int star)
#else
void saacproto_ACCharList_send(int fd, char *id, char *pas, char *ip,
                               char *mac1, char *mac2, char *mac3, int mesgid,
                               int charlistflg)
#endif
{
  saacproto_CreateHeader(saacproto.work, "ACCharList");
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(pas),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(ip),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(mac1),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(mac2),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(mac3),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(mesgid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charlistflg),
                       saacproto.workbufsize);

#ifdef _PKSEVER_VER
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(star),
                       saacproto.workbufsize);
#endif
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACCharLoad_send(int fd, char *id, char *pas, char *charname,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(pas),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(lock),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(opt),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(mesgid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
#endif
{
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(opt),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charinfo),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(unlock),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(mesgid),
                       saacproto.workbufsize);
#ifdef _NEWSAVE
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(saveindex),
                       saacproto.workbufsize);
#endif
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACCharDelete_send(int fd, char *id, char *passwd, char *charname,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(passwd),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(option),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(mesgid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACUCheck_send(int fd, char *mem_id, int status) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(mem_id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(status),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_DBUpdateEntryString_send(int fd, char *table, char *key,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(table),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(key),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(value),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid2),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_DBUpdateEntryInt_send(int fd, char *table, char *key, int value,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(key),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(value),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(info),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid2),
...
void saacproto_DBGetEntryByRank_send(int fd, char *table, int rank_start,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(table),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(rank_start),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(rank_end),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid2),
...
void saacproto_DBGetEntryByCount_send(int fd, char *table, int count_start,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(table),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(count_start),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(num),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid2),
...
/*
608 :  <LI><a name="Broadcast"><font color=red>clienttoserver Broadcast( string
id, string charname, string message , int flag );</font></a><BR> 609 :
必□丞扔□田□卞覆仄化仇及戊穴件玉毛霜耨允月午｝ 610 :
允屯化及必□丞扔□田□卞凶中仄化  元丢永本□斥互霜耨今木月［ 611 : 	 id , charname
反方仁勾井歹木月及匹｝蜊  及娄醒毛手勾方丹卞仄凶［ 612 : 	 中切中切  侬
由□旦及伙□民件毛踏井卅仁化手中中方丹卞［ 613 : 	 <dl> 614 : 	   <dt>string id
615 : 	   <dd>user ID
...
void saacproto_Broadcast_send(int fd, char *id, char *charname, char *message,
  ...
  /*
          ...
          saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( id )
     ,saacproto.workbufsize ); saacproto_strcatsafe( saacproto.work ,
     saacproto_mkstr_string( charname ) ,saacproto.workbufsize );
          saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( message
     ) ,saacproto.workbufsize ); saacproto_strcatsafe( saacproto.work ,
...
/*
634 :  <LI><a name="Message"><font color=red>clienttoserver Message( string
id_from, string charname_from, string id_to, string charname_to, string message
, int option );</font></a><BR> 635 : 	 奶件旦正件玄丢永本□斥毛霜耨允月 636 :
<dl> 637 : 	   <dt>string id_from 638 : 	   <dd>from ID 639 :
<dt>string charname_from 640 : 	   <dd>from Character name 641 :
<dt>string id_to 642 : 	   <dd>to ID 643 : 	   <dt>string charname_to 644 :
<dd>to character name 645 : 	   <dt>string message 646 : 	   <dd>丢永本□斥
647 : 	   <dt>int option
...
void saacproto_Message_send(int fd, char *id_from, char *charname_from,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id_from),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname_from),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id_to),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname_to),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(message),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(option),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_MessageAck_send(int fd, char *id, char *charname, char *result,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(mesgid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
#endif
{
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(fmname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(fmleadername),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(fmleaderid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmleaderlv),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(petname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(petattr),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(fmrule),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmsprite),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmleadergrano),
                       saacproto.workbufsize);
  // #ifdef _PERSONAL_FAME
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fame),
                       saacproto.workbufsize);
  // #endif
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
#ifdef _NB_FAMILYBADGE
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmbadge),
                       saacproto.workbufsize);
#endif
  saacproto_Send(fd, saacproto.work);
}
...
#endif
{
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(fmname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charlv),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  // #ifdef _PERSONAL_FAME	// Arminius: 家族个人声望
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fame),
                       saacproto.workbufsize);
...
void saacproto_ACShowMemberList_send(int fd, int index) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string("MemberList"),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
#endif
{
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(result),
                       saacproto.workbufsize);
#ifdef _FMVER21
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(meindex),
                       saacproto.workbufsize);
#endif
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
...
#endif
{
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charlv),
                       saacproto.workbufsize);
#ifdef _FMVER21
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(eventflag),
                       saacproto.workbufsize);
#endif
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
#ifdef _FM_MODIFY
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(gsnum),
                       saacproto.workbufsize);
#endif
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACFMReadMemo_send(int fd, int index) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string("ReadMemo"),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACFMWriteMemo_send(int fd, char *fmname, int fmindex, char *data,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACSetFMPoint_send(int fd, char *fmname, int fmindex, int index,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmpointindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fl),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(x),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(y),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACFixFMPoint_send(int fd, char *winfmname, int winfmindex,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(winfmname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(winfmindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(winindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(losefmname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(losefmindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(loseindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(village),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
void saacproto_ACFMAnnounce_send(int fd, char *fmname, int fmindex, int index,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(color),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
void saacproto_ACShowTopFMList_send(int fd, int kindflag) {
  saacproto_CreateHeader(saacproto.work, "ACShowTopFMList");
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string("ShowTopFMList"),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(kindflag),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACFixFMData_send(int fd, char *fmname, int fmindex, int index,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(kindflag),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data1),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data2),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
...
void saacproto_ACGMFixFMData_send(int fd, int index, char *charid, char *cmd,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string("ACGMFixFMData"),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(index),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(charid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(cmd),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
...
void saacproto_ACreLoadFmData_send(int fd, int type, int data) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(type),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(data),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACLoadFmPk_send(int fd, int fmpks_pos) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmpks_pos),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACSendFmPk_send(int fd, int toindex, int PkFlg, int fmpks_pos,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmpks_pos),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(toindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(PkFlg),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(msg),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
#endif
...
int saacproto_ClientDispatchMessage(int fd, char *line) {
  ...
  /*
  354 :  <LI><a name="DBUpdateEntryStringS"><font color=blue>servertoclient
  DBUpdateEntryString( string result, string table, string key, int msgid, int
  msgid2 );</font></a><BR> 355 : 	 晓及戊穴件玉及瑛绊［撩  仄化手荚汊尕第
  卅及匹  骰仄化方中冗 356 : 	 <dl> 357 : 	   <dt>string result 358 :
  <dD>successful 井failed 359 : 	   <dt>string table 360 : 	   <dD>
  361 : 	   <dt>int msgid
  362 : 	   <dD>
  363 : 	   <dt>int msgid2
  364 : 	   <dD>
  ...
  */
  ...
  /*
  379 :  <LI><a name="DBDeleteEntryStringS"><font color=blue>servertoclient
  DBDeleteEntryString( string result, string table, string key , int msgid , int
  msgid2 );</font></a><BR> 380 : 	   侬  巨件玄伉及绰轮及瑛绊 381 :
  <dl> 382 : 	   <dt>string result 383 : 	   <dd>successful / failed 384 :
  <dt>string table 385 : 	   <dd> 386 : 	   <dt>string key 387 :
  <dd> 388 : 	   <dt>int msgid 389 : 	   <dd> 390 : 	   <dt>int msgid2 391 :
  <dd> 392 : 	 </dl> 393 :
  */
  ...
  /*
  406 :  <Li><a name="DBGetEntryStringS"><font color=blue>servertoclient
  DBGetEntryString( string result, string value, string table, string key, int
  msgid, int msgid2 );</font></a><BR> 407 : 	 潸曰分仄及忒曰袄 408 :
  <dl> 409 : 	   <dt>string result 410 : 	   <dd>successful / failed 411 :
  <dt>string value 412 : 	   <dd>袄 413 : 	   <dt>string table 414
  : 	   <dd> 415 : 	   <dt>string key 416 : 	   <dd> 417 : <dt>int
  msgid 418 : 	   <dd> 419 : 	   <dt>int msgid2 420 : 	   <dd> 421 :
  </dl> 422 :
  */
  ...
  /*
  445 :  <LI><a name="DBUpdateEntryIntS"><font color=blue>servertoclient
  DBUpdateEntryInt( string result , string table, string key, int msgid, int
  msgid2 );</font></a><BR> 446 : 	 DBUpdateEntry及瑛绊［ 447 : 	 <dl>
  ...
  */
  ...
  /*
  473 :  <LI><a name="DBGetEntryRankS"><font color=blue>servertoclient
  DBGetEntryRank( string result , int rank , int count, string table, string
  key, int msgid, int msgid2 );</font></a><BR> 474 : 	 赐匏毛忒允［ 475 :
  <dl> 476 : 	   <dt>string result 477 : 	   <dd>successful/failed 478 :
  <dt>int rank 479 : 	   <dd>赐匏［1动晓及袄毛潸月［ 480 : 	   <dt>int count
  ...
  */
  ...
  /*
  504 :  <LI><a name="DBDeleteEntryIntS"><font color=blue>servertoclient
  DBDeleteEntryInt( string result , string table, string key, int msgid, int
  msgid2 );</font></a><BR> 505 : 	 绰轮及瑛绊 506 : 	 <dl> 507 :
  <dt>string result 508 : 	   <dd>successful/failed 509 : <dt>string table
  510 : 	   <dd>  □皮伙  毛公及引引井尹允
  511 : 	   <dt>string key
  512 : 	   <dd>平□毛公及引引井尹允
  ...
  */
  ...
  /*
  530 :  <LI><a name="DBGetEntryIntS"><font color=blue>servertoclient
  DBGetEntryInt( string result , int value , string table, string key, int
  msgid, int msgid2 );</font></a><BR> 531 : 	 巨件玄伉及袄毛井尹允 532 :
  <dl> 533 : 	   <dt>string result 534 : 	   <dd>successful/failed 535 :
  <dt>int value 536 : 	   <dd>袄公及手及 537 : 	   <dt>string table 538
  : 	   <dd>  □皮伙  毛公及引引井尹允 539 : 	   <dt>string key 540 :
  <dd>平□毛公及引引井尹允 541 : 	   <dt>int msgid, int msgid2 542 :
  <dd>msgid 毛公及引引忒允 543 : 	 </dl> 544 : 545 : 546 :
  */
...
#endif
  /*
  621 :  <LI><a name="Broadcast"><font color=blue>servertoclient Broadcast(
  string id, string charname, string message );</font></a><BR> 622 :
  Broadcast及失市它件玄扔□田□井日必□丞扔□田□尺及霜耨迕 623 : 	 <dl> 624 :
  <dt>string id 625 : 	   <dd>user ID 626 : 	   <dt>string charname 627 :
  <dd>character name 628 : 	   <dt>string message 629 : 	   <dd>丢永本□斥
  630 : 	   <dt>int flag
  ...
  */
  ...
  /*
  652 :  <LI><a name="Message"><font color=blue>servertoclient Message( string
  id_from, string charname_from, string id_to, string charname_to, string
  message , int option , int mesgid );</font></a><BR> 653 :
  失市它件玄扔□田□井日必□丞扔□田□卞丢永本□斥毛霜耨允月［ 654 : 	 <dl> 655 :
  <dt>string id_from 656 : 	   <dd>from ID 657 : 	   <dt>string
  charname_from 658 : 	   <dd>from character name 659 : 	   <dt>string
  id_to 660 : 	   <dd>to ID 661 : 	   <dt>string charname_to 662 :
  <dd>to character name 663 : 	   <dt>string message 664 : <dd>丢永本□斥及 665
  : 	   <dt>int option 666 : 	   <dd>左皿扑亦件(晓及楮醒毛辅寰) 667 :
  <dt>int mesgid 668 : 	   <dd>丢永本□斥ID 失市它件玄扔□田□及栋  迕 669 :
  </dl> 670 :
  */
  ...
  if (strcmp(funcname, "ACFmPkOnlineSn") == 0) {
    ...
    gsname = saacproto_wrapStringAddr(
        saacproto_stringwrapper[2], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[3]));
...
#endif
#ifdef _NB_GM_SERVERLIST //跨服GM指令
  if (strcmp(funcname, "GMSERVERLIST") == 0) {
    int itype;
    char *msg;
    itype = saacproto_demkstr_int(saacproto.token_list[2]);
    msg = saacproto_wrapStringAddr(
        saacproto_stringwrapper[3], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[3]));
    printf("\n接收到跨服指令，编号:%d 参数:%s\n", itype, msg);
    saacproto_gm_shutdown_recv(itype, msg);
    return 0;
  }
#endif
...
void saacproto_SetClientLogFiles(char *r, char *w) {
  saacproto_strcpysafe(saacproto_readlogfilename, r,
                       sizeof(saacproto_readlogfilename));
  saacproto_strcpysafe(saacproto_writelogfilename, w,
...
void saacproto_ACKick_send(int fd, char *kickid, int kickfd, int flg) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(kickid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(kickfd),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(flg),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
#endif
...
void saacproto_ACCharSavePoolItem_send(int acfd, int charaindex, int clifdid,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(CdKey),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(Pooldataarg),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charaindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(clifdid),
                       saacproto.workbufsize);
...
void saacproto_ACMissionTable_send(int acfd, int num, int type, char *data,
  ...
  // saacproto_strcatsafe( saacproto.work , saacproto_mkstr_int( charaindex )
  // ,saacproto.workbufsize );
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(angelinfo),
                       saacproto.workbufsize);
  saacproto_Send(acfd, saacproto.work);
}
#endif
...
void saacproto_ACCheckCharacterOnLine_send(int acfd, int charaindex, char *id,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(name),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(flag),
                       saacproto.workbufsize);
  saacproto_Send(acfd, saacproto.work);
}
#endif
...
void saacproto_ACCharLogin_send(int fd, int clifd, char *id, char *pas, char *ip
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(clifd),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(pas),
...
void saacproto_QueryPoint_send(int acfd, int fd, char *id) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fd),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_Send(acfd, saacproto.work);
...
void saacproto_NewVipShop_send(int acfd, int fd, char *id, int point, char *buf,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(point),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(buf),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(flag),
                       saacproto.workbufsize);
  saacproto_Send(acfd, saacproto.work);
...
void saacproto_ItemPetLocked_send(int fd, char *id, char *safepasswd) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(safepasswd),
                       saacproto.workbufsize);
  saacproto_Send(acfd, saacproto.work);
}
...
void saacproto_OnlineCost_send(int acfd, int fd, char *id, char *costpasswd,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(costpasswd),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(fmname),
...
void saacproto_CharadataSaveSQL_send(int fd, char *id, Charadata charadata,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(id),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work,
...
#ifdef _ALL_SERV_SEND
void saacproto_AllServSend_send(char *data, int color) {
...
void saacproto_ACFmPkOnlineSn_send(int acfd, int manorindex, int flag) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(manorindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(flag),
                       saacproto.workbufsize);
  saacproto_Send(acfd, saacproto.work);
...
#ifdef _NB_GM_SERVERLIST //跨服GM指令
void saacproto_gm_shutdown_send(int itype, char *msg) {
  saacproto_CreateHeader(saacproto.work, "GMSERVERLIST");
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(itype),
                       saacproto.workbufsize); //传递类型编号
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(msg),
                       saacproto.workbufsize); //传递参数
  saacproto_Send(acfd, saacproto.work);        //发送至SAAC
}
#endif

#ifdef _NB_GETPLAYERMAX
void saacproto_playmax_send(char *ip) {
  saacproto_CreateHeader(saacproto.work, "PLAYERMAX");
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(ip),
                       saacproto.workbufsize); //传递参数
  saacproto_Send(acfd, saacproto.work);        //发送至SAAC
}

void saacproto_getplaymax_send(int maxnum) {
  saacproto_CreateHeader(saacproto.work, "GETPLAYERMAX");
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(maxnum),
                       saacproto.workbufsize); //传递类型编号
  saacproto_Send(acfd, saacproto.work);        //发送至SAAC
}
#endif

...
static void NPC_PetRaceMaster_selectWindow(int meindex, int toindex, int num,
                                           int select);
...
PetRaceGraTable petracegra[27] = {
    {100820, 100821, 100822, "扑满乌力", "乌力莱德", "乌力固力", 0, 0, 0,
     "良好", "良好", "良好"},
    {100823, 100824, 100825, "布依布鲁", "布依布依", "布依胖", 0, 0, 0, "良好",
     "良好", "良好"},
    {100842, 100843, 100844, "尼加斯", "尼基斯", "特洛可斯", 0, 0, 0, "良好",
     "良好", "良好"},
    {100852, 100853, 100855, "克拉尔", "拉斯基", "克达达", 0, 0, 0, "良好",
     "良好", "良好"},
    {100859, 100856, 100857, "可卡特", "卡卡特", "昆依特", 0, 0, 0, "良好",
     "良好", "良好"},
    {100864, 100865, 100866, "蓝宝", "瑞德宝", "毛宝", 0, 0, 0, "良好", "良好",
     "良好"},
    {100829, 100826, 100827, "比比加", "加加", "加斯奥", 0, 0, 0, "良好",
     "良好", "良好"},
    {100830, 100832, 100833, "乌宝依", "威比", "乌拉拉", 0, 0, 0, "良好",
     "良好", "良好"},
    {100883, 100884, 100885, "尤里蛙", "裘里蛙", "艾尔蛙", 0, 0, 0, "良好",
     "良好", "良好"},
    {100898, 100900, 100901, "可可恩", "布兰恩", "迪布恩", 0, 0, 0, "良好",
     "良好", "良好"},
    {100834, 100836, 100837, "贝洛金", "贝洛贝", "贝洛波波", 0, 0, 0, "良好",
     "良好", "良好"},
    {100838, 100840, 100841, "蓝龟", "龟之钢", "卡拉龟", 0, 0, 0, "良好",
     "良好", "良好"},
    {100879, 100881, 100880, "迪加", "波波顿", "砂鲨", 0, 0, 0, "良好", "良好",
     "良好"},
    {100888, 100887, 100889, "莫拉司", "欧瑟菲", "玛斯特", 0, 0, 0, "良好",
     "良好", "良好"},
    {100913, 100914, 100915, "莱姆洛斯", "朱利洛斯", "辛普洛斯", 0, 0, 0,
     "良好", "良好", "良好"},
    {100845, 100846, 100847, "呼波波", "呼鲁鲁", "鲁拉其斯", 0, 0, 0, "良好",
     "良好", "良好"},
    {100849, 100850, 100851, "邦诺斯娜", "杨格斯", "迪基格斯", 0, 0, 0, "良好",
     "良好", "良好"},
    {100878, 100876, 100877, "玻洛布斯", "加耶布斯", "迪米布斯", 0, 0, 0,
     "良好", "良好", "良好"},
    {100908, 100909, 100906, "阿米朵", "邦司凉朵", "朵巴奈特", 0, 0, 0, "良好",
     "良好", "良好"},
    {100916, 100918, 100919, "立杜鲁斯", "巴克亚司", "雷德力克斯", 0, 0, 0,
     "良好", "良好", "良好"},
    {100860, 100862, 100861, "司尔顿", "梅尔顿", "格尔希洛", 0, 0, 0, "良好",
     "良好", "良好"},
    {100867, 100870, 100868, "欧林吉鲁", "芭拉芭", "史凯鲁", 0, 0, 0, "良好",
     "良好", "良好"},
    {100871, 100873, 100874, "普鲁夏", "萨格鲁", "玛斯贝卡", 0, 0, 0, "良好",
     "良好", "良好"},
    {100894, 100895, 100896, "固力摩", "摩吉摩吉", "摩米索拉", 0, 0, 0, "良好",
     "良好", "良好"},
    {100902, 100903, 100905, "格里兰", "摩里", "塔斯夫", 0, 0, 0, "良好",
     "良好", "良好"},
    {100912, 100911, 100910, "伊夫霍恩", "布依伦斯", "布莱兹", 0, 0, 0, "良好",
     "良好", "良好"},
    {100891, 100892, 100893, "嘎吱拉", "哥斯哥斯", "蒙哥拉斯", 0, 0, 0, "良好",
     "良好", "良好"},
};
#else
PetRaceGraTable petracegra[27] = {
    {100820, 100821, 100822, "扑满乌力", "乌力莱德", "乌力固力", 0, 0, 0, 2, 2,
     2, "良好", "良好", "良好"},
    {100823, 100824, 100825, "布依布鲁", "布依布依", "布依胖", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100842, 100843, 100844, "尼加斯", "尼基斯", "特洛可斯", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100852, 100853, 100855, "克拉尔", "拉斯基", "克达达", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100859, 100856, 100857, "可卡特", "卡卡特", "昆依特", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100864, 100865, 100866, "蓝宝", "瑞德宝", "毛宝", 0, 0, 0, 2, 2, 2, "良好",
     "良好", "良好"},
    {100829, 100826, 100827, "比比加", "加加", "加斯奥", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100830, 100832, 100833, "乌宝依", "威比", "乌拉拉", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100883, 100884, 100885, "尤里蛙", "裘里蛙", "艾尔蛙", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100898, 100900, 100901, "可可恩", "布兰恩", "迪布恩", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100834, 100836, 100837, "贝洛金", "贝洛贝", "贝洛波波", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100838, 100840, 100841, "蓝龟", "龟之钢", "卡拉龟", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100879, 100881, 100880, "迪加", "波波顿", "砂鲨", 0, 0, 0, 2, 2, 2, "良好",
     "良好", "良好"},
    {100888, 100887, 100889, "莫拉司", "欧瑟菲", "玛斯特", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100913, 100914, 100915, "莱姆洛斯", "朱利洛斯", "辛普洛斯", 0, 0, 0, 2, 2,
     2, "良好", "良好", "良好"},
    {100845, 100846, 100847, "呼波波", "呼鲁鲁", "鲁拉其斯", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100849, 100850, 100851, "邦诺斯娜", "杨格斯", "迪基格斯", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100878, 100876, 100877, "玻洛布斯", "加耶布斯", "迪米布斯", 0, 0, 0, 2, 2,
     2, "良好", "良好", "良好"},
    {100908, 100909, 100906, "阿米朵", "邦司凉朵", "朵巴奈特", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100916, 100918, 100919, "立杜鲁斯", "巴克亚司", "雷德力克斯", 0, 0, 0, 2,
     2, 2, "良好", "良好", "良好"},
    {100860, 100862, 100861, "司尔顿", "梅尔顿", "格尔希洛", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100867, 100870, 100868, "欧林吉鲁", "芭拉芭", "史凯鲁", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100871, 100873, 100874, "普鲁夏", "萨格鲁", "玛斯贝卡", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100894, 100895, 100896, "固力摩", "摩吉摩吉", "摩米索拉", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100902, 100903, 100905, "格里兰", "摩里", "塔斯夫", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100912, 100911, 100910, "伊夫霍恩", "布依伦斯", "布莱兹", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
    {100891, 100892, 100893, "嘎吱拉", "哥斯哥斯", "蒙哥拉斯", 0, 0, 0, 2, 2, 2,
     "良好", "良好", "良好"},
};
#endif
...
void NPC_PetRaceMasterTalked(int meindex, int talkerindex, char *szMes,
                             int color) {
  // 尚须新增说明以及宠物状况
...
static void NPC_PetRaceMaster_selectWindow(int meindex, int toindex, int num,
  ...
  case 2: {
    ...
    if (petracegra[petgroup].payrate1 == 0)
      ...
      snprintf(cpayrate1, sizeof(cpayrate1), "%6.2f",
               petracegra[petgroup].payrate1);
    if (petracegra[petgroup].payrate2 == 0)
      snprintf(cpayrate2, sizeof(cpayrate2), "???");
    else
      snprintf(cpayrate2, sizeof(cpayrate2), "%6.2f",
               petracegra[petgroup].payrate2);
    if (petracegra[petgroup].payrate3 == 0)
      snprintf(cpayrate3, sizeof(cpayrate3), "???");
    else
      snprintf(cpayrate3, sizeof(cpayrate3), "%6.2f",
               petracegra[petgroup].payrate3);
#endif
    if (total == 0) {
      winrate1 = 0;
      winrate2 = 0;
...
void NPC_PetRaceMasterWindowTalked(int meindex, int talkerindex, int seqno,
...
void NPC_PetRaceMasterLoop(int meindex) {
    ...
    if (t1 < statechangetime) {
      if (statechangetime - t1 <= 5) {
        CHAR_setInt(meindex, CHAR_LOOPINTERVAL,
                    PETRACEMASTER_WAITDROPIV_LOOPTIME);
        snprintf(tmpbuf, sizeof(tmpbuf),
                 "还有%2d秒就要开跑了，请大家踊跃下注！",
                 (int)(statechangetime - t1) % 60);
      } else if (statechangetime - t1 <= 10) {
        CHAR_setInt(meindex, CHAR_LOOPINTERVAL,
                    PETRACEMASTER_WAITDROPIII_LOOPTIME);
        snprintf(tmpbuf, sizeof(tmpbuf),
                 "还有%2d秒就要开跑了，请大家踊跃下注！",
                 (int)(statechangetime - t1) % 60);
      } else if (statechangetime - t1 <= 30) {
        CHAR_setInt(meindex, CHAR_LOOPINTERVAL,
                    PETRACEMASTER_WAITDROPII_LOOPTIME);
        snprintf(tmpbuf, sizeof(tmpbuf),
                 "还有%2d秒就要开跑了，请大家踊跃下注！",
                 (int)(statechangetime - t1) % 60);
      } else
        snprintf(tmpbuf, sizeof(tmpbuf),
                 "还有%2d分钟%2d秒就要开跑了，请大家踊跃下注！",
                 (int)(statechangetime - t1) / 60,
                 (int)(statechangetime - t1) % 60);
    }
    if (t1 >= statechangetime) {
      ...
      float droprate1 = 0, droprate2 = 0, droprate3 = 0, totaldroprate,
            Npayrate = PETRACESTDPAYRATE;
#endif
      int i = 0;
      ...
      snprintf(tmpbuf, sizeof(tmpbuf),
               "请大家停止下注，宠物赛跑开始罗！%s的赔率为%5.2f；%s的赔率为%5."
               "2f；%s的赔率为%5.2f",
      ...
      for (i = 0; i < PETRACEPETNUM; i++) {
        CHAR_setWorkInt(CHAR_getWorkInt(meindex, NPC_WORK_PET1 + i),
                        NPC_WORK_STATE, NPC_State_Run);
        CHAR_setInt(CHAR_getWorkInt(meindex, NPC_WORK_PET1 + i),
                    CHAR_LOOPINTERVAL, 1000);
      }
    }
  ...
  case NPC_State_PetRacing:
    if (CHAR_getWorkInt(meindex, NPC_WORK_PETGOAL) == PETRACEPETNUM) {
      ...
      CHAR_setInt(meindex, CHAR_LOOPINTERVAL,
                  PETRACEMASTER_SHOWWINPET_LOOPTIME);
...
void NPC_findRacePetIndex(int meindex, int floor) {
  ...
  if (CHAR_getWorkInt(meindex, NPC_WORK_FINDPETFLAG) == 0) {
    ...
    if (CHAR_getWorkInt(meindex, NPC_WORK_PET1) > 0 &&
      ...
      CHAR_setWorkInt(meindex, NPC_WORK_FINDPETFLAG, 0);
  }
}

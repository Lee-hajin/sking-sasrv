...
static void NPC_TranserMan_selectWindow(int meindex, int toindex, int num,
                                        int select);
...
void NPC_TranserManWindowTalked(int meindex, int talkerindex, int seqno,
  ...
  case NPC_TRANSERMAN_SELECT:
    NPC_TranserMan_selectWindow(meindex, talkerindex, WINDOW_SELECT,
                                atoi(data));
    break;
...
BOOL TranserMan_GetMenuStr(int meindex, int toindex, char *npcarg,
                           char *token) {

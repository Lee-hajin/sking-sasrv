...
void NPC_GambleRoulette_selectWindow(int meindex, int toindex, int num,
                                     int select);
...
GambleEndType EndTypedef[60] = {
    {22, 8, roulette1, roulette41, roulette43, roulette51, roulette61,
     "号码红１", 0},
    {7, 8, roulette1, roulette41, roulette43, roulette51, roulette61,
     "号码红１", 0},
    {22, 10, roulette3, roulette41, roulette43, roulette51, roulette61,
     "号码红３", 0},
    {7, 6, roulette3, roulette41, roulette43, roulette51, roulette61,
     "号码红３", 0},
    {20, 11, roulette5, roulette41, roulette43, roulette51, roulette61,
     "号码红５", 0},
    {9, 5, roulette5, roulette41, roulette43, roulette51, roulette61,
     "号码红５", 0},
    {19, 5, roulette6, roulette41, roulette44, roulette53, roulette61,
     "号码红６", 0},
    {10, 11, roulette6, roulette41, roulette44, roulette53, roulette61,
     "号码红６", 0},
    {17, 5, roulette8, roulette41, roulette44, roulette53, roulette61,
     "号码红８", 0},
    {12, 11, roulette8, roulette41, roulette44, roulette53, roulette61,
     "号码红８", 0},
    {16, 5, roulette9, roulette41, roulette43, roulette53, roulette61,
     "号码红９", 0},
    {13, 11, roulette9, roulette41, roulette43, roulette53, roulette61,
     "号码红９", 0},
    {15, 5, roulette10, roulette41, roulette44, roulette53, roulette61,
     "号码红１０", 0},
    {14, 11, roulette10, roulette41, roulette44, roulette53, roulette61,
     "号码红１０", 0},
    {12, 5, roulette13, roulette41, roulette43, roulette52, roulette62,
     "号码红１３", 0},
    {17, 11, roulette13, roulette41, roulette43, roulette52, roulette62,
     "号码红１３", 0},
    {22, 6, roulette17, roulette41, roulette43, roulette53, roulette62,
     "号码红１７", 0},
    {7, 10, roulette17, roulette41, roulette43, roulette53, roulette62,
     "号码红１７", 0},
    {22, 5, roulette18, roulette41, roulette44, roulette52, roulette62,
     "号码红１８", 0},
    {7, 11, roulette18, roulette41, roulette44, roulette52, roulette62,
     "号码红１８", 0},

    {22, 9, roulette22, roulette42, roulette44, roulette51, roulette61,
     "号码绿２", 0},
    {7, 7, roulette22, roulette42, roulette44, roulette51, roulette61,
     "号码绿２", 0},
    {21, 11, roulette24, roulette42, roulette44, roulette51, roulette61,
     "号码绿４", 0},
    {8, 5, roulette24, roulette42, roulette44, roulette51, roulette61,
     "号码绿４", 0},
    {18, 5, roulette27, roulette42, roulette43, roulette53, roulette61,
     "号码绿７", 0},
    {11, 11, roulette27, roulette42, roulette43, roulette53, roulette61,
     "号码绿７", 0},
    {19, 11, roulette31, roulette42, roulette43, roulette51, roulette62,
     "号码绿１１", 0},
    {10, 5, roulette31, roulette42, roulette43, roulette51, roulette62,
     "号码绿１１", 0},
    {18, 11, roulette32, roulette42, roulette44, roulette51, roulette62,
     "号码绿１２", 0},
    {11, 5, roulette32, roulette42, roulette44, roulette51, roulette62,
     "号码绿１２", 0},
    {16, 11, roulette34, roulette42, roulette44, roulette52, roulette62,
     "号码绿１４", 0},
    {14, 5, roulette34, roulette42, roulette44, roulette52, roulette62,
     "号码绿１４", 0},
    {15, 11, roulette35, roulette42, roulette43, roulette52, roulette62,
     "号码绿１５", 0},
    {13, 5, roulette35, roulette42, roulette43, roulette52, roulette62,
     "号码绿１５", 0},
    {22, 7, roulette36, roulette42, roulette44, roulette53, roulette62,
     "号码绿１６", 0},
    {7, 9, roulette36, roulette42, roulette44, roulette53, roulette62,
     "号码绿１６", 0},
    {21, 5, roulette39, roulette42, roulette43, roulette52, roulette62,
     "号码绿１９", 0},
    {8, 11, roulette39, roulette42, roulette43, roulette52, roulette62,
     "号码绿１９", 0},
    {20, 5, roulette40, roulette42, roulette44, roulette52, roulette62,
     "号码绿２０", 0},
    {9, 11, roulette40, roulette42, roulette44, roulette52, roulette62,
     "号码绿２０", 0},
...
BOOL NPC_Gamble_MasterInit(int meindex) {
  ...
  if (NPC_Util_GetStrFromStrWithDelim(argstr, "gamble_code", buf1,
                                      sizeof(buf1)) == NULL) {
...
void NPC_Gamble_MasterTalked(int meindex, int talkerindex, char *szMes,
                             int color) {
  char argstr[NPC_UTIL_GETARGSTR_BUFSIZE];
...
void NPC_GambleRoulette_selectWindow(int meindex, int toindex, int num,
  ...
  case ROULETTE_START:
    ...
    while (NPC_Util_GetStrFromStrWithDelim(npcarg, buf2, buf1, sizeof(buf1)) !=
           NULL) {
  ...
  case ROULETTE_SELECT:
    ...
    if (NPC_Util_GetStrFromStrWithDelim(npcarg, buf2, token, sizeof(token)) ==
        NULL) {
    ...
    sprintf(buf2, "%s%2d", "page_num",
            CHAR_getWorkInt(toindex, CHAR_WORKSHOPRELEVANT));
    if (NPC_Util_GetStrFromStrWithDelim(npcarg, buf2, buf1, sizeof(buf1)) ==
        NULL) {
  ...
  case ROULETTE_END:
    if (NPC_Util_GetStrFromStrWithDelim(npcarg, "page_endmsg", token,
                                        sizeof(token)) == NULL) {
...
void NPC_Gamble_MasterWindowTalked(int meindex, int talkerindex, int seqno,
  ...
  case WINDOWTYPE_GAMBLEROULETTE_START:
    ...
    if (pagenum == 4) {
      ...
      if (pagenum == 3) { // ROULETTE_LOOK
        NPC_GambleRoulette_selectWindow(meindex, talkerindex, ROULETTE_LOOK,
                                        -1);
      } else {
        pagenum = (pagenum * 10) + 1;
        NPC_GambleRoulette_selectWindow(meindex, talkerindex, ROULETTE_SELECT,
                                        pagenum);
      }
    }
    break;
...
void NPC_Gamble_MasterLoop(int meindex) {
  ...
  case 0: // 等待
    ...
    if ((CHAR_getWorkInt(meindex, NPC_WORK_SYSTIME) + full_time) <
        NowTime.tv_sec) {
      if (timeNum == 30) { //倒数20秒
        // 0 null 1 准备 2 跑 3 停
  ...
  case 2: // GAME END
    ...
    LogGamble(CHAR_getChar(meindex, CHAR_NAME), "master", "ROULETTE",
          ...
          {	//记录用
                  ...
                  if( fp != NULL )	{
                          if( EndTypedef[ End_type].m_nums < 10000 )
                                  EndTypedef[ End_type].m_nums = EndTypedef[
  End_type].m_nums+1; for( kp=0; kp<arraysizeof( EndTypedef)-1; kp++ )	{ if(
  EndTypedef[ kp].m_nums > 0 && EndTypedef[ kp].m_type > 0 )	{ fprintf( fp,"
  %s 中奖次数 [%d] ", EndTypedef[ kp].str_type, EndTypedef[ kp].m_nums ); if( (pn+1)%2 == 0 )	{ fprintf( fp," \n");
                                          }
                                          pn ++;
                                  }
                          }
    ...
    for (i = 0; i < 5; i++) {
      ...
      if (player_type > 0) {
        if (player_type == EndTypedef[End_type].m_type) { //中了号码
          ...
          GAMBLE_YES = TRUE;
          //算钱
          Codef_Gold(meindex, toindex, gamble_num, 0,
                     EndTypedef[End_type].str_type);
          ...
          if ((player_type >> 16) == EndTypedef[End_type].m_type ||
              (player_type & 0xffff) == EndTypedef[End_type].m_type) { //中双号
            gamble_num += 10;
            GAMBLE_YES = TRUE;
            ...
            strcpy(token, "\0");
            if (player_type >= roulette41 &&
                player_type <= roulette44) { //红绿单双
              sprintf(token, "%s", "押注 红绿单双 没中");
            } else if (player_type == roulette45) { //数字00
              sprintf(token, "%s", "押注 数字00 没中");
            } else if (player_type >= roulette51 &&
                       player_type <= roulette53) { //横列
              sprintf(token, "%s", "押注 横列 没中");
            } else if (player_type >= roulette61 &&
                       player_type <= roulette62) { //范围
...
void Codef_Gold(int meindex, int toindex, int stone, int flg, char *token) {
  ...
  if (!flg) {
    ...
    stone += 1; //加上一开始下注扣的积分
#endif
    CHAR_setInt(toindex, CHAR_GAMBLENUM,
                CHAR_getInt(toindex, CHAR_GAMBLENUM) + stone);
  ...
  LogGamble(CHAR_getChar(toindex, CHAR_NAME), CHAR_getChar(toindex, CHAR_CDKEY),
            "ROULETTE", CHAR_getInt(toindex, CHAR_FLOOR),
            CHAR_getInt(toindex, CHAR_X), CHAR_getInt(toindex, CHAR_Y),
            CHAR_getInt(toindex, CHAR_GOLD), stone, 0,
            CHAR_getInt(toindex, CHAR_GAMBLENUM), 1);

  //纪录盈亏
  if (Master_gnum > 5000000)
    Master_gnum = 5000000;
  if (Master_gnum < 0)
    Master_gnum = 0;
